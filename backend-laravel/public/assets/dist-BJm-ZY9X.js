...
`,$=new Map,se=(e,t)=>{W(()=>{if(!e||typeof document>`u`)return;let n=document,r=$.get(n);if(r){t&&r.setAttribute(`nonce`,t);return}let i=n.createElement(`style`);i.textContent=e,t&&i.setAttribute(`nonce`,t),n.head.appendChild(i),$.set(n,i)},[t])};function ce(e){return se(oe,e.nonce),r.createElement(ae,{...e})}export{z as n,ce as t};