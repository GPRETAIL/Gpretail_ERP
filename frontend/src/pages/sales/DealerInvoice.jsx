    ...
    <Box sx={{ display: "grid", height: "100%", minHeight: 0, gridTemplateColumns: { xs: "1fr", xl: "repeat(12, 1fr)" }, gap: 2 }}>
      <Stack spacing={1.5} sx={{ gridColumn: { xl: "span 3" }, height: "100%", minHeight: 0, overflowY: "auto", overflowX: "hidden", bgcolor: "background.paper", border: "1px solid", borderColor: "divider", borderRadius: "7px", boxShadow: 1, p: 1.5 }}>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 1 }}>
          <Box>
            <Typography component="label" sx={{ display: "block", mb: 0.5, fontSize: 11.5, fontWeight: 500, color: "text.secondary" }}>SO No</Typography>
            <TextField
              type="text"
              value={soNo}
          ...
          <Box>
            <Typography component="label" sx={{ display: "block", mb: 0.5, fontSize: 11.5, fontWeight: 500, color: "text.secondary" }}>Remarks</Typography>
            <TextField
              type="text"
              value={remarks}
