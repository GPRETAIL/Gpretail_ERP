...
const TABLE_COLUMNS = [
  { key: "description", label: "Description", align: "left", width: "50%" },
  { key: "sold_pieces", label: "Sold Pieces", align: "right", width: "25%" },
  { key: "stock_pieces", label: "Available Stock Pieces", align: "right", width: "25%" },
];
                ...
                filteredData.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-right text-gray-700 dark:text-gray-300 tabular-nums">
                      {fmtInt(row.sold_pieces)}
                    </td>
                    <td className="px-3 py-2 text-right text-indigo-600 dark:text-indigo-400 tabular-nums font-medium">
                      {fmtInt(row.stock_pieces)}
                    </td>
                  </tr>
                ))
              )}
