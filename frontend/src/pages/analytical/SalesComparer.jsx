...
const TABLE_COLUMNS = [
  ...
  { key: "qty_sold", label: "Qty Sold", align: "right", width: "10%" },
  { key: "qty_returned", label: "Returned", align: "right", width: "10%" },
  { key: "net_qty", label: "Net Qty", align: "right", width: "10%" },
  { key: "net_amount", label: "Sale Amt", align: "right", width: "13%" },
  { key: "net_cost", label: "Cost Amt", align: "right", width: "13%" },
  { key: "total_discount", label: "Discount", align: "right", width: "10%" },
  { key: "margin_perc", label: "Margin %", align: "right", width: "8%" },
  { key: "markup_perc", label: "Mark Up %", align: "right", width: "8%" },
];
              ...
              {loading ? (
                ...
                filteredData.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-right text-orange-600 dark:text-orange-400 tabular-nums">
