        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Upload, extract, review and create a warehouse purchase invoice.
            </p>
          </div>
        </div>
              ...
              <div className="mt-5 space-y-5">
                ...
                <div className="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                  <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                    <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Supplier & Product Mapping</h3>
                    <span className="text-xs text-gray-500">Required before posting</span>
                  </div>
                  <div className="p-4 space-y-4">
                    <div>
                      <label className="text-xs font-medium text-gray-600 dark:text-gray-300">Supplier</label>
                      <select value={supplierId} onChange={(e) => setSupplierId(e.target.value)} className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 px-3 py-2 text-sm">
...
const Field = ({ label, value }) => (
  <div className="rounded-lg bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 p-3">
    ...
    <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white truncate">{value || "—"}</p>
  </div>
);
