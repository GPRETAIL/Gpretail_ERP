...
export const A4_TEMPLATE_TYPES = [
  {
    ...
    badge: "Standard",
    badgeColor: { bg: "#dbeafe", color: "#1e40af", darkBg: "rgba(30,58,138,0.4)", darkColor: "#93c5fd" },
  ...
  },
  {
    ...
    name: "Glass Template",
    badge: "Modern",
    badgeColor: { bg: "#cffafe", color: "#155e75", darkBg: "rgba(22,78,99,0.4)", darkColor: "#67e8f9" },
  ...
  },
  {
    ...
    badge: "GST Focus",
    badgeColor: { bg: "#e0e7ff", color: "#3730a3", darkBg: "rgba(49,46,129,0.4)", darkColor: "#a5b4fc" },
  ...
  },
  {
    ...
    badge: "Classic",
    badgeColor: { bg: "#fef3c7", color: "#92400e", darkBg: "rgba(120,53,15,0.4)", darkColor: "#fcd34d" },
  ...
  },
  {
    ...
    name: "Tally Template",
    badge: "Tally Style",
    badgeColor: { bg: "#e2e8f0", color: "#1e293b", darkBg: "#334155", darkColor: "#e2e8f0" },
  ...
  },
  {
    ...
    badge: "Colour",
    badgeColor: { bg: "#f3e8ff", color: "#6b21a8", darkBg: "rgba(88,28,135,0.4)", darkColor: "#d8b4fe" },
  ...
  },
  {
    ...
    badge: "Emerald",
    badgeColor: { bg: "#d1fae5", color: "#065f46", darkBg: "rgba(6,78,59,0.4)", darkColor: "#6ee7b7" },
  ...
  },
  {
    ...
    badge: "Sunset",
    badgeColor: { bg: "#ffedd5", color: "#9a3412", darkBg: "rgba(124,45,18,0.4)", darkColor: "#fdba74" },
  ...
  },
  {
    ...
    badge: "Wide Format",
    badgeColor: { bg: "#ccfbf1", color: "#115e59", darkBg: "rgba(19,78,74,0.4)", darkColor: "#5eead4" },
  ...
  },
  {
    ...
    badge: "Minimal",
    badgeColor: { bg: "#e5e7eb", color: "#1f2937", darkBg: "#374151", darkColor: "#d1d5db" },
...
export const THERMAL_TEMPLATE_TYPES = [
  ...
  },
  {
    ...
    name: "Tally Thermal",
    badge: "Grid Style",
    badgeColor: { bg: "#e4e4e7", color: "#27272a", darkBg: "#3f3f46", darkColor: "#e4e4e7" },
