...
export function ReturnsCard({ summary = {}, performance = {}, loading, privacyMode }) {
  ...
  return (
    <div
      ...
      className="group h-full cursor-pointer rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition hover:border-rose-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-800"
    >
      <div className="flex items-center justify-between text-slate-500 dark:text-gray-400">
