...
class PHPExcel_NamedRange
{
     ...
     */
    public function __construct($pName = null, PHPExcel_Worksheet $pWorksheet = 'Default worksheet', $pRange = 'A1', $pLocalOnly = false, $pScope = null)
    {
        // Validate data
     ...
     * @return PHPExcel_NamedRange
     */
    public static function resolveRange($pNamedRange = '', PHPExcel_Worksheet $pSheet = 'Default worksheet')
    {
