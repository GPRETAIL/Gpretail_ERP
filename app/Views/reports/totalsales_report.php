<table id="chltkarr" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
        ...
        <tr class="hideme" style="text-align:center;"><th colspan="9">Sales Summary Reports from <?= esc($start) ?> Till <?= esc($end) ?></th></tr>
        <tr style="background:#1c76bc;color:#fff;border: 1px solid #1c76bc;">
            <th style="border: 1px solid #1c76bc;">Total Bill</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:center;"><?= esc($row['items']) ?></td>
    ...
    <tfoot>
        <tr>
            ...
            <td style="text-align:right;"><b><?= number_format($subTotal, $decimals) ?></b></td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td style="text-align:center;"><b>Cancel</b></td>
            <td style="text-align:right;"><b><?= number_format($cancelTotal, $decimals) ?></b></td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td style="text-align:center;"><b>Return</b></td>
            <td style="text-align:right;"><b><?= number_format($returnTotal, $decimals) ?></b></td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td style="text-align:center;"><b>Total</b></td>
            <td style="text-align:right;"><b><?= number_format($netTotal, $decimals) ?></b></td>
        </tr>
    </tfoot>
</table>
