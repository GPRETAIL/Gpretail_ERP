...
background: #F2F7FA;font-family:'Roboto', sans-serif;">
                    ...
                    <div class="col-sm-4" style="padding-left: 0px;padding-right:  0px;">
                        <form onsubmit="return barcode()" action="javascript:void(0)">
                            <input autofocus style="margin-top:10px;" placeholder="Barcode or Product Name  " autocomplete="off" onkeyup="return auromcv(this.value,this.id);" class="form-control barcode" type='text' id='countryname_1m' '/>

<!-- <input  style="margin-top:10px;" type="text" autofocus id="<?= strval($setting->keyboard) === '1' ? 'keyboard' : '' ?>" class="form-control barcode" placeholder="<?= label('BarcodeScanner'); ?>"> -->
            </form>
                    ...
                    ?>
                        ...
                        <div class="footer-section">
                            ...
                            <div class="table-responsive col-sm-12 totalTab">
                                ...
                                <table class="table" style="border: 1px solid #ddd !important;    margin-top: 6px;margin-bottom: 3px !important;">

                                    <tr style=" ">
                                        <?php if ($setting->disc_all == 1) { ?>
                                            <input type="hidden" name="allddd" id="allddd" value="1">
                                            <td class="" style="text-align: center; width:18%;padding: 5px;font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;"><b><?= label("Discount"); ?></b> (%)
...
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" value="<?= $setting->discount; ?>" onkeyup="total_change()" id="<?= strval($setting->keyboard) === '1' ? 'num02' : '' ?>" class="total-input Remise " placeholder="N/A">
                                        ...
                                        <?php } else {  ?>
                                            <td class="" style="width:18%;padding: 14px;font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;"> &nbsp;
                                                <input type="hidden" name="allddd" id="allddd" value="0">
                                                <input type="hidden" value="0" onchange="total_change()" id="<?= strval($setting->keyboard) === '1' ? 'num02' : '' ?>" class="total-input Remise" placeholder="N/A" maxlength="5">
                                        ...
                                        <td class="" style="padding: 5px;text-align: center; font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;" width="18%">
                                            <b><?= label("Shipping"); ?></b>
...
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" value="" onkeyup="total_changeddish()" id="disamtssh" class="total-input  " placeholder="Shipping">
                                        ...
                                        <td class="" style="padding: 5px;text-align: center; font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;" width="18%">
                                            ...
                                            <select class="form-control" id="paymentMethod" style="width: 100%;height: 30px;float: right;background-color: #fff;display: block;padding: 5px;
line-height: 1.42857143;
color: #555;
text-align: center;
background-color: #fff;
...
-webkit-box-shadow: inset 0 1px 1px rgba(0,0,0,.075);
box-shadow: inset 0 1px 1px rgba(0,0,0,.075);
-webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;G
-o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;">
                                        ...
                                        <td class="" style="padding: 5px; font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;" width="25%">
                                            <b><?= label("SubTotal"); ?></b><br>
                                            <b><span style="margin-right: <?php echo $msk * 7; ?>%" class="float-right"><span id="Subtot"></span></b>
                                        </td>

                                        <td class="" style="padding: 5px;text-align: center; font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;" width="20%"><b><?= label("Receivedamount"); ?></b>
...
-webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;
-o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" value="0" onkeyup="return callcc(this.value,this.id);" name="recivedamt" class="form-control <?= strval($setting->keyboard) === '1' ? 'paidk' : '' ?>" id="recivedamt">

                                        </td>
                                    </tr>
                                    <tr style=" ">
                                        <td style="width:10%; text-align: center; padding: 5px;font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;">
...
-webkit-transition: border-color ease-in-out .15s,-webkit-box-shadow ease-in-out .15s;
-o-transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" value="<?= $setting->discount; ?>" onkeyup="total_changeddi()" id="disamtss" class="total-input  " placeholder="N/A">
                                        ...
                                        <td class="" style="padding: 5px; text-align: center; font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;"><b><?= label("Mobile"); ?></b>
                                            <input value="" style="width: 100%;height: 30px;float: right;background-color: #fff;display: block;padding: 6px 10px;
line-height: 1.42857143;
color: #555;
text-align: center;
background-color: #fff;
...
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" name="mobnnm" class="-control" id="mobnnm" />
                                        ...
                                        <td class="" style="padding: 5px; text-align: center;font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;">
                                            ...
                                            <div class="form-group ChequeNum" style="margin: 0 0 0px 0 !important;">
                                                <br>
                                        ...
                                        <td style="padding: 5px;border: 1px solid #ddd !important;color:red;" class="  text-bold">
                                            ...
                                            <span style="margin-right: <?php echo $msk * 7; ?>%;font-size: 32px;color: #0052ad;" class="float-right"><i style="font-size: 25px;" class="fa fa-rupee"></i> <b id="total"></b></span>
                                        </td>


                                        <td style="padding: 5px;text-align: center;">
                                            <b style="padding: 5px;"><?= label("Balanceamt"); ?></b>
                                            <h3 style="color:red;margin-top: 0px;" id="bamacee"><i style="font-size: 25px;" class="fa fa-rupee"></i> <span></span> </h3>
                                        </td>
                                ...
                                ?>
                                    ...
                                    <input type="hidden" value="<?= $setting->tax; ?>" onchange="total_change()" id="<?= strval($setting->keyboard) === '1' ? 'num01' : '' ?>" class="total-input TAX" placeholder="N/A" maxlength="5">
                            ...
                            <button style="width: 31%;margin-left: 0.4%;border: 1px solid #B7B7B7 !important;" type="button" class="btn btn-green col-md-4 flat-box-btn " data-toggle="modal" data-target="#AddSale">
                                <h4 class="text-bold"><i style="color:#fff;" class="fa fa-money"></i> <?= label('PAYEMENT'); ?> (F2)</h4>
                            </button>

                            <a onclick="quickpay()" style="width: 31%;margin-left: 0.4%;border: 1px solid #B7B7B7 !important;" href="javascript:void(0)" class="btn btn-green col-md-4 flat-box-btn ">
                                <h4><i style="color:#fff;" class="fa fa-print"></i> <?= label('Quick Pay & Print'); ?> (F4)</h4>
                            </a>
...
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" name="mobnnm" class="-control" id="mobnnm" />
                                    ...
                                    <tr style=" ">
                                        ...
                                        <td class="" style="padding: 5px; font-family:'Roboto', sans-serif;border: 0px solid #ddd !important;" width="20%"><b><?= label("Receivedamount"); ?></b>
...
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" value="0" onkeyup="return callcc(this.value,this.id);" name="recivedamt" class="form-control <?= strval($setting->keyboard) === '1' ? 'paidk' : '' ?>" id="recivedamt">
                            ...
                            <a onclick="quickpay()" style="width: 56%;margin-left: 24%;margin-top: 4%;border: 1px solid #B7B7B7 !important;" href="javascript:void(0)" class="btn btn-green col-md-4 flat-box-btn ">
                                <h4><i style="color:#fff;" class="fa fa-print"></i> <?= label('Quick Pay & Print'); ?> (F4)</h4>
                            </a>
                    ...
                    ?>
                        ...
                        if ($setting->destpp == 0) { ?>
                            ...
                            /*$categxx=mysql_query("select name,price,descountperr,category,photothumb,id,color from products ");*/
                            $categxx = $db->query("SELECT * FROM products LIMIT 100")->getResult();
                            foreach ($categxx as $product) {
                                ...
                                if ($cheked) {
                                    ...
                                    @$omssv = $db->query("select * from stocks where store_id='" . $session->get('store') . "'  and product_id ='" . $product->id . "'  ")->getRowArray();
                                ...
                                ?>
                                    ...
                                    ?>
                                        ...
                                        <div class="col-sm-3 col-xs-3" style="padding: 2px;">
                                            <button style="width: 100%;border: 0px;padding-left: 0px;padding-right: 0px;background: transparent;border: 1px solid #dbdbdb;" class="addPct" id="product-<?= $product->code; ?>" onclick="add_posalenk('<?= $product->id; ?>')">
                                                <div class="product flat-box">
                                                ...
                                                <span class="ng-binding"><?php echo  substr(ucfirst($product->name), 0, 15); ?></span>
                                            </button>
                                        </div>
                                    ...
                                    ?>
                                        ...
                                        <div class="col-sm-12 " style="padding: 2px 0px;">
                                            <a href="javascript:void(0)" class="addPct" id="product-<?= $product->code; ?>" onclick="add_posalenk('<?= $product->id; ?>')">
                                                <div style="height: 30px;background: linear-gradient(to bottom, #ffffff 0%,#eeeeee 100%); width: 100%; border-radius: 0px; text-align: left; background-size: cover; margin-top: 2px; color: #000; overflow: hidden;">
                                                    <h3 style="margin-top: 7px;font-size: 14px;font-family: sans-serif;" id="proname">&nbsp;&nbsp;&nbsp;<?php echo  substr($product->name, 0, 60); ?></h3>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    $('#productList').load("<?php echo site_url('pos/qload_posales') ?>/0");
                    $('#Subtot').load("<?php echo site_url('pos/qsubtot') ?>", null, total_change);


                    $('#ItemsNum span, #ItemsNum2 span').load("<?php echo site_url('pos/qtotiems') ?>");
                    $('.holdList').load("<?php echo site_url('pos/holdList/' . $register) ?>");
                    $('#cgstt').load("<?php echo site_url('pos/qcalcgst') ?>", null, total_change);
                    $('#sgstt').load("<?php echo site_url('pos/qcalsgst') ?>", null, total_change);
                ...
                function delete_posale(id) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('pos/qdelete') ?>/" + id,
                        type: "POST",
                        dataType: "JSON",
                        success: function(data) {
                            $('#productList').load("<?php echo site_url('pos/qload_posales') ?>/" + idc);
                            $('#ItemsNum span, #ItemsNum2 span').load("<?php echo site_url('pos/qtotiems') ?>");
                            $('#Subtot').load("<?php echo site_url('pos/qsubtot') ?>", null, total_change);
                            $('#cgstt').load("<?php echo site_url('pos/qcalcgst') ?>", null, total_change);
                            $('#sgstt').load("<?php echo site_url('pos/qcalsgst') ?>", null, total_change);
                    ...
                    swal({
                        ...
                        function() {
                            ...
                            $.ajax({
                                ...
                                dataType: "JSON",
                                success: function(data) {
                                    $('#productList').load("<?php echo site_url('pos/qload_posales') ?>/" + id);
                                    $('#ItemsNum span, #ItemsNum2 span').load("<?php echo site_url('pos/qtotiems') ?>");
                                    $('#Subtot').load("<?php echo site_url('pos/qsubtot') ?>", null, total_change);
                                    $('.holdList').load("<?php echo site_url('pos/holdList/' . $register) ?>");
                                    $('#cgstt').load("<?php echo site_url('pos/qcalcgst') ?>", null, total_change);
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data === 'stock') {
                                ...
                                $('#productList').load("<?php echo site_url('pos/qload_posales') ?>/" + idkm);
                ...
                function add_posalenk(id) {
                    ...
                    // ajax delete data to database
                    $.ajax({
                        url: "<?php echo site_url('pos/addpdc_qt') ?>/",
                        type: "POST",
                        data: {
                            xcust: xcust,
                            ddpp: ddpp,
                ...
                function disxn() {
                    ...
                    var zs2 = $('#Paid').val();
                    var zs3 = parseFloat(zs1) - parseFloat(zs2) + parseFloat(tot_creaditpoint) + parseFloat(retamt);
                ...
                function edit_posale(id) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('pos/qedit') ?>/" + id,
                        type: "POST",
                        data: {
                            qt: qt1,
                            decc: decc
                ...
                $("#customerSelect").change(function() {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('pos/qGetDiscount') ?>/" + id,
                        type: "POST",
                        success: function(data) {
                            $('#productList').load("<?php echo site_url('pos/qload_posales') ?>/" + id);
                            $('#ItemsNum span, #ItemsNum2 span').load("<?php echo site_url('pos/qtotiems') ?>");
                            ...
                            $('#TotalModal').text('<?= label("Total"); ?>Rs.' + jjjj.toFixed(<?= $setting->decimals; ?>));
                ...
                function cancelPOS() {
                    swal({
                        ...
                        function() {
                            ...
                            $.ajax({
                                url: "<?php echo site_url('pos/qResetPos') ?>/",
                                type: "POST",
                                success: function(data) {
                                    $('#productList').load("<?php echo site_url('pos/qload_posales/0') ?>");
                                    $('#Subtot').load("<?php echo site_url('pos/qsubtot') ?>", null, total_change);
                ...
                function saleBtn(type) {
                    ...
                    var tot_creaditpoint = $('#tot_creaditpoint').val();
                    if (paidMethod == 2) {
                    ...
                    var tturl = "<?php echo site_url('pos/qAddNewSale') ?>/" + type;

                    $.ajax({
                        url: tturl,
                        type: "POST",
                        data: {
                            tot_creaditpoint: tot_creaditpoint,
                            creddate: creddate,
                            disamtssh: disamtssh,
                            custrrf: custrrf,
                            recivamt: recivamt,
            ...
            <div class="modal fade" id="AddSale" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h3 style="width:33%;float: left;font-family: bold;margin-top: 0px;margin-bottom: 1px;" id="TotalModal">
                                </h4>
                        ...
                        <form>
                            <div class="modal-body">
                                ...
                                <table class="table table-striped  " style="border: 1px solid #ddd;margin-bottom: 0px;font-family: " Roboto", sans-serif;">
                                    ...
                                    if ($kkar['salretv'] == 1) { ?>
                                        ...
                                        <tr>
                                            <td style="border-top: 0px solid #ddd;">
                                                ...
                                                <button style="padding: 6px 0px;width:50px;float: left;margin-bottom: 0px;background-color: #489103;" class="btn btn-add" type="button" onclick="education_fields();">Check</button>
                                            </td>
                                            ...
                                            <td style="border-top: 0px solid #ddd;"><input value="0" style="width:80%;border: 1px solid #ccc;padding: 5px 12px;background-color: #edf2f6;" type="text" readonly="readonly" name="amttt" class="-control" id="amttt" />
                                            </td>
                                        </tr>
                                    ...
                                    <input readonly="readonly" type="hidden" value="0" name="paid" class="form-control <?= strval($setting->keyboard) === '1' ? 'paidk' : '' ?>" id="Paid" placeholder="<?= label("Paid"); ?>">
                                    ...
                                    <?php if ($setting->creditstatus == 1) { ?>
                                        ...
                                        <input type="hidden" style="width:57%;border: 1px solid #ccc;padding: 5px 12px;" name="creddate" class="form-control <?= strval($setting->keyboard) === '1' ? 'paidk' : '' ?>" id="creddate" placeholder="<?= label("Credit Days"); ?>">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-add" onclick="saleBtn(1)"><?= label("save&print"); ?> (F2)</button>
                            </div>
                            <?php echo form_close(); ?>
                    </div>
                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="col-xs-4">
                                    <label for="PurchasePrice"><?= label("PurchasePrice"); ?> (<?= $setting->currency; ?>)</label>
                            ...
                            <div class="col-xs-12">
                                <label for="Unit">Net Wight</label>
...
margin-left: 14%;" class="fa fa-plus fa-stack-1x  "></i>
                                        ...
                                        <div style="height: 90px;overflow-y: scroll;" id="ttaxx">
                                            <?php
                                            // $taxx = $db->query("select * from tax where status=1 order by name asc");
                                            $taxes = $db->table('tax')
                                                ->where('status', 1)
                                                ->orderBy('name', 'ASC')
                                                ->get()
                                            ...
                                            foreach ($taxes as $tax) {
                                                ...
                                                <span style="float: left;width: 10%">
                                                    <input type="checkbox" style="display: block;" name="ckk[]" id="ckc" value="' . $rt . '" checked>
                                                </span>
                                                <span style="float: left;width:80%;margin-left:5%;">' . $rt1 . '-' . $rt2 . '%
                                                </span>
                                            </div>';
                                            }
        ...
        function gauthamm(ccc) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    document.getElementById('retidd').value = ii;
                    document.getElementById('amttt').value = jj;
    ...
    <script>
        ...
        function edit_posalepp(id) {
            ...
            var idkm = $('#customerSelect').find('option:selected').val();
            $.ajax({
                url: "<?php echo site_url('pos/qeditpp') ?>/" + id,
                type: "POST",
                data: {
                    qt: qt1,
                    decc: decc
        ...
        function edit_proeditt(id) {
            ...
            $.ajax({
                url: "<?php echo site_url('pos/qedit_proname') ?>/" + id,
                type: "POST",
                data: {
                    qt: qt1
                },
