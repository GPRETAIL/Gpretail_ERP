...
<div class="container">
    ...
    <div class="row" style="margin-top:10px;">
        ...
        <form action="<?= base_url('products') ?>" method="POST">
            <div class="input-group" style="float: right;">
                ...
                <input type="text" class="form-control" placeholder="Product Name or Barcode" value="<?= isset($_POST['productInput']) ? $_POST['productInput'] : '' ?>" name="productInput" id="productInput">
            ...
            <style>
                ...
                /* Ensure all table headers have enough space */
                #Table3s thead th {
                    /* min-width: 100px; */
            ...
            <div class="table-container">
                <table id="Table3s" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Code</th>
                            ...
                            <th><?= label("Brand Name"); ?></th>
                            <th>Tax %</th>
                            <th>Purchase Price</th>
                            <th>Selling Price</th>
                            <th>MRP</th>
                            <th>Discount %</th>
                            <th>Store Avail Qty</th>
            ...
            <div style="text-align: center; margin-top: 20px;" class="pagination-section">
                <?php 
                
                //echo $paginate 
                ?>

                <p style="display: inline-block;padding-top: 13px;">Showing page <?php echo (!empty($uri->getSegment(2)) ? $uri->getSegment(2) : 50 / $per_page) + 1; ?> of <?php echo $total_pages; ?></p>
                | <?php echo $pager->links(); ?> <!-- Show pagination links -->
    ...
    <!-- /.container -->
    <?php echo view('modals/_imageViewer'); ?>
    ...
    <script type="text/javascript">
        ...
        function loadTable() {
            ...
            $('#Table3s').DataTable({
                ...
                "paging": false,
                "ajax": {
                    'url': '<?= site_url('InvoicesPro/ajaxList/' . $offset . '/' . $per_page) ?>',
                    'type': 'post',
                    'data': {
                        user_id: 4,
