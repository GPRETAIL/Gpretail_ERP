      <table  style="width: 60%;" class="table table-striped table-bordered" cellspacing="0"  >
          <thead>
              <tr>
                  ...
                  <th style="text-align: center;" >Selling Store <?=label("Price");?> </th>
...
if($prince_mas==0)
{
  $pppp_price=$product->price;
}
else
{

$myy=mysql_fetch_array(mysql_query("select * from price_marterr where pp_pro_id ='".$product->id."' and pp_price_type ='".$prince_mas."'  "));
if($myy)
{
...
<td style="text-align: center;"  >
 <input type="hidden" name="pro_pprice[]" id="pro_pprice_<?php echo $product->id;?>" value="<?=$product->price;?>"> 
