...
<div class="container">
    <div class="row" style="margin-top:10px;">
        <div class="col-md-12">
            ...
            <h3><?= label('Add'); ?><a style="float: right;" class="btn btn-primary btn-red" href="<?php echo base_url(); ?>PhysicalStock"><?= label('Back'); ?></a></h3>
            <hr>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group">&nbsp;&nbsp;<?= label('Voucher'); ?> <?= label('Number'); ?>
                            ...
                            $ikmm = $db->query("select id from physivcal_stock order by id desc ")->getRowArray();
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group">&nbsp;&nbsp;<?= label('Store'); ?>
                            <select required="required" class="form-control" id="warr" name="warr">
                                ...
                                // $query = $db->table('stores')->orderBy('name', 'asc');
                                // $stores = $query->getResult();
                                $stores = $db->query("select * from stores order by name asc ")->getResult();
                                print_r($stores);
                                ?>
