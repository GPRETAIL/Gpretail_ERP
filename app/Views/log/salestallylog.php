<!-- app/Views/log/salestallylog.php -->

<div class="container">
    <h3>Sales Log - Tally</h3>
    <hr>
            ...
            <tbody>
                <?php foreach ($log as $category): ?>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-default" href="<?= base_url('reports/seldownloadxl/' . esc($category->sii)); ?>">Excel</a>
                                <a class="btn btn-default" href="<?= base_url('log/seldownloadxml/' . esc($category->sii)); ?>">XML</a>
                            </div>
                        </td>
                    </tr>
                <?php endforeach; ?>
