...
<style>
    ...
    /* Ensure column widths align in scrollable tbody */
...
<style>
    .fixed-thead-scroll-tbody {
        width: 100%;
        border-collapse: collapse;
    }

    .fixed-thead-scroll-tbody thead {
        display: table;
        width: 100%;
        table-layout: fixed;
    ...
    .fixed-thead-scroll-tbody tbody {
        display: block;
        max-height: 350px;
    ...
    .fixed-thead-scroll-tbody tbody tr {
        display: table;
        width: 100%;
        table-layout: fixed;
    }
...
<div class="container">
        ...
        <div class="col-md-12" style="padding: 0px;padding-right: 1px;padding-left: 1px;">
            ...
            <script type="text/javascript">
                ...
                function remove_education_fields(rid) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#total_invoice_discount_amount').val(0);
                            $('#total_invoice_discount_percentage');
                            $('#freight_cost').val(0);
                ...
                function callcc(cc, bb) {
                    ...
                    for (var i in ss) {
                        ...
                        if (elementExists != null) {
                            ...
                            if (elementExists != null) {
                                ...
                                total_percentage += parseFloat($('.discount_percent_' + xt).val());
                    ...
                    // $("#total_invoice_discount_amount").val(total_dicount.toFixed(2));
                    // $("#total_invoice_discount_percentage").val(total_percentage.toFixed(2));
                    var ccrt1 = parseFloat(cc1) / 2 / 10;
                    var dd1 = document.getElementById('ddkst').value;

                    // + parseFloat(ss1)
                    var flss1 = parseFloat(amtt) + parseFloat(cc1) - parseFloat(dd1);

                    $("#betot").val(amtt.toFixed(2));
                    $("#get_betot").val(amtt.toFixed(2));
                ...
                function callcctt_fibnal(cc, bb) {
                    ...
                    var agent_name = document.getElementById('agent').value;
                    ...
                    if (innvamt != afftot) {
                        ...
                        var _cgst = document.getElementById('_cgst').value;
                        var _sgst = document.getElementById('_sgst').value;
                        var _igst = document.getElementById('_igst').value;
                        var _gst = document.getElementById('_gst').value;


                        var agent_comission = [];
                        $("input[name='agent_comission[]']").each(function(index) {
                            agent_comission[index] = $(this).val();
                        });
                        ...
                        if (pptye == 1) {
                            ...
                            no_of_credit_days = $('#no_of_credit_days').val();
                            if (no_of_credit_days == '') {
                                $('#no_of_credit_days').focus();
                                return false;
                            }
                        } else if (pptye == 2) {
                        ...
                        var total_invoice_discount_amount = document.getElementById('total_invoice_discount_amount').value;
                        var total_invoice_discount_percentage = document.getElementById('total_invoice_discount_percentage').value;
                        var freight_cost = document.getElementById('freight_cost').value;
                        var agent_commission_percentage = document.getElementById('agent_commission').value;
                        var agent_commission_amount = document.getElementById('agent_commission_amount').value;
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                total_invoice_discount_amount: total_invoice_discount_amount,
                                total_invoice_discount_percentage: total_invoice_discount_percentage,
                            ...
                            success: function(data) {
                                swal({
                                    ...
                                    function(isConfirm) {
                                        if (isConfirm) {
                                            // User clicked "Yes"
                                            window.location.href = "<?php echo site_url(); ?>printbarcodes/PurchaseLabelPrint/" + data.purid;
                                        } else {
                                            // User clicked "Cancel"
            ...
            <h3 style="padding: 0px; margin-bottom: 0; <?php
                                                        if ($lxzmm['purchase_type'] == '1') { ?>background: #7ec9ff;<?php
                                                                                                                }
                                                                                                                    ?>"><?= label('Add') ?>
                <?= label('Purchase') ?>

                <?php
                if ($lxzmm['purchase_type'] == '1') {
                    echo '(Stock)';
                }
                ?>
            ...
            <div class="panel-body" style="padding: 0px; padding-right: 1px;padding-left: 1px;">
                ...
                <div class="col-sm-2 pptye_1">
                    <div class="form-group"><?= label('Credit amount') ?>
                        <input type="text" name="credit_amount" id="credit_amount" class="form-control" placeholder="Credit Amount">
                    </div>
                </div>
                <div class="col-sm-2 pptye_1">
                    <div class="form-group"><?= label(' No of Credit days') ?>
                        <input type="number" min="1" value="1" name="no_of_credit_days" id="no_of_credit_days" class="form-control" placeholder="No of Credit Days">
                    </div>
                </div>
                ...
                <div class="col-sm-2 pptye_2">
                    <div class="form-group"><?= label('Cheque') ?> <?= label('Date') ?>
                        <input type="date" name="cheque_date" id="cheque_date" class="form-control" placeholder="Cheque Date">
                    </div>
                </div>
                <script>
                    $(document).ready(function() {
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group"><?= label('Warehouses') ?>
                            ...
                            <select class="form-control" id="warr" name="warr">
                                ...
                                <?php
                                $mjm = $db->query("select * from warehouses order by name asc ")->getResultArray();
                                foreach ($mjm as $mjmf) {
                                ?>
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group"><?= label('Store') ?>
                            <select class="form-control" id="storrid" name="storrid">
                                <?php
                                $mjms = $db->query("select * from stores order by name asc ")->getResultArray();
                                foreach ($mjms as $mjmfs) {
                                ?>
                                    <option value="<?php echo $mjmfs['id']; ?>" <?= $mjmfs['id'] == session()->get('store') ? 'selected' : '' ?>><?php echo $mjmfs['name']; ?></option>
                                <?php
                                }
                                ?>
                            </select>
    ...
    line-height: 1em;" title="" data-original-title="Add New Suppliers">
                        ...
                        <select class="form-control" id="supp" name="supp">
                            <?php
                            $mjm = $db->query("select * from suppliers order by name asc ")->getResultArray();
                            foreach ($mjm as $mjmf) {
                            ?>
                                <option value="<?php echo $mjmf['id']; ?>"><?php echo $mjmf['name']; ?></option>
                            <?php
            ...
            <div class="panel-body" style="padding: 0px;padding-right: 1px;padding-left: 1px;">
                ...
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Agent') ?>
                        <input class="form-control" type="text" name="agent" id="agent" value="" />
                    </div>
                </div>
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Alert QTY') ?>
                        <input class="form-control" type="text" name="alert_qty_" id="alert_qty_" value="" />
                    </div>
                </div>
                ...
                <div class="col-sm-12 " style="padding: 0px; padding-right: 1px;padding-left: 1px;">
                    <div class="panel-body" style="background-color: #FFF; padding: 15px 0px;">
                                ...
                                <table class="table table-striped" style="margin-bottom: 0;">
                                    <thead>
                                        <tr style="text-align: center;">
                                            ...
                                            ?>
                                                <th style="width: 8%;"><?= label('Category') ?></th>
                                            <?php } else { ?>
                                                <th style="width: 8%;"><?= label('Barcode') ?></th>
                                            <?php } ?>
                                            <th><?= label('Product') ?></th>
                                            <!-- <th><?= label('Pro Size') ?></th> -->
                                            <th><?= label('Brand') ?></th>
                                    ...
                                    <tbody>
                                        <tr>
                                                    ...
                                                    <div>
                                                        <div class="form-group">
                                                            <select class="form-control" id="cattff" name="cattff">
                                                                ...
                                                                <?php
                                                                $mjmc = $db->query("select * from categories order by name asc ")->getResultArray();
                                            ...
                                            <td style="width: 8%; display: none;">
                                                <div class="form-group">
                                                    <input style="padding: 0px 0px;" autocomplete="off" class="form-control inputTab" type='text' id='pro_size' placeholder="Pro Size" data-index="2">
                                                </div>
                                            </td>
                                            <td style="width: 8%;">
                                                <div class="form-group">
                                                    <input type="text" id="brandInput" name="brandInput" onkeyup="return brandNew(this.value,this.id);" class="form-control  inputTab" data-index="3">
                                                    <input type="hidden" id="branddd" name="branddd" value="">
                                                </div>
                                            </td>
                                            <td style="width: 8%;">
                                                <div class="form-group">
                                                    <select class="form-control" name="category_" id="category_">
                                                        <option value="0">Select</option>
                                            ...
                                            <td style="width: 8%;">
                                                <div class="form-group">
                                                    <input style="padding: 0px 0px; padding-left: 10px;" type="text" onkeyup="return calstrip(this.value,this.id);" class="form-control inputTab" id="qty_1m" value="" placeholder="Quantity" data-index="4">
                                                </div>
                                            </td>
                                            <?php
                                            if ($lxzmm['gst_tax'] == 1) { ?>
                                            ...
                                            <?php } ?>
                                            <td style="width: 8%;">
                                                <select name="taxtype" id="taxtype" class="form-control inputTab" data-index="5">
                                                    <option value="">Select</option>
                                                    <!-- <option value="1">Local State</option>
                                                    <option value="2">Other State</option>
                                                    <option value="3">GST</option> -->
                                                    <?php
                                                    $taxes = $db->table('tax')->where('tax_for', 1)->get()->getResult();
                                                    foreach ($taxes as $tax) {
                                                        echo '<option value="' . $tax->id . '">' . $tax->name . ' ' . ($tax->taxtype == 1 ? '(In)' : '(Ex)') . '</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </td>
                                            <td style="width: 8%;">
                                                <div class="form-group">
                                                    <input type="text" class="form-control inputTab" id="cosst_1m" value="" placeholder="Cost" onkeyup="calpur_price()" data-index="6"><br>
                                                    <input type="hidden" class="form-control" id="cosst_1m_calculate">
                                                </div>
                                            </td>
                                            <?php
                                            if ($lxzmm['expi'] == 1) {
                                            ...
                                            ?>
                                                <td style="width: 8%;">
                                                    <input style="padding: 0px 0px;" type="text" class="form-control" id="mrp_1m" value="" placeholder="MRP">
                                                </td>
                                                <td style="width: 8%;">
                                                    <input style="padding: 0px 0px;" type="text" class="form-control" id="sel_dis" value="" onkeyup="calculeteSelDis()" placeholder="Sel Dis">
                                                    <input type="hidden" name="dis_amt" id="dis_amt">
                                                </td>
                                            <?php } ?>
                                            <td style="width: 8%;">
                                                ...
                                                <div class="form-group">
                                                    <input style="padding: 0px 0px; padding-left: 10px;" type="text" class="form-control inputTab" id="selling_1m" value="" placeholder="Selling Price" data-index="7"><br>
                                                </div>
                                            </td>
                                            <td style="width: 8%;">
                                                <div class="input-group">
                                                    <input style="padding: 0px 0px;" type="text" class="form-control inputTab text-center" id="product_discount" value="" placeholder="Dis Amt" data-index="8">
                                                </div>
                                            </td>
                                            <td style="width: 8%;">
                                                <div class="form-group">
                                                    <input style="padding: 0px 0px;" type="text" class="form-control inputTab text-center" id="product_percentage" value="" placeholder="Dis %" data-index="9">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <input style="padding: 0px 0px; padding-left: 10px; width: 80px;" readonly="readonly" type="text" class="form-control inputTab" value="0" id="subtt_1m" value="" placeholder="Cost">
                                                    <div class="input-group-btn">
                                                        <button class="btn btn-success" id="btn-product-add" type="button" onclick="barcodekar();" data-index="10">
                        ...
                        <script>
                            function calculeteSelDis() {
                                let mrp = $('#mrp_1m').val();
                                let sel_dis = $('#sel_dis').val();
                                let amount = (mrp / 100) * sel_dis;
                                let sel_price = mrp - amount;
                                $('#selling_1m').val(sel_price);
                                $('#dis_amt').val(amount);
                            }
                    ...
                    <script>
                        $('#product_discount').keyup(function(e) {
                            ...
                            var pur_price = $('#cosst_1m_calculate').val();
                            ...
                            var new_pur_price = (st_total / quantity).toFixed(2);
                            console.log(new_pur_price);
                            $('#cosst_1m').val(new_pur_price);
                            $('#subtt_1m').val(st_total.toFixed(2));
                        });
                        ...
                        $('#product_percentage').keyup(function(e) {
                            ...
                            $('#product_discount').val(st.toFixed(2));
                        ...
                        $("#cosst_1m").on('change keyup', function() {
                            var val = $(this).val();
                            $('#cosst_1m_calculate').val(val);
                        });
                    </script>
                        ...
                        <div class="panel-body" style="padding: 0px;">
                            ...
                            <div class="table-div">
                                <div class="table-container">
                                    <table class="table-bordered fixed-thead-scroll-tbody" id="pur_pro_table">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center; width: 30px;" class="">
                                                    <?= label('SN') ?>
                                                </th>
                                                <th style="text-align: center; width: 9%;" class="">
                                                    <?= label('Barcode') ?>
                                                </th>
                                                <th style="text-align: center; width: 8%;" class="">
                                                    <h7><?= label('Brand') ?></h7>
                                                </th>
                                                <th style="text-align: center; width: 8%;" class="">
                                                ...
                                                <th style="text-align: center; width: 8%;" class="table-header">
                                                ...
                                                if ($lxzmm['expi'] == 1) {
                                                ?>
                                                    <th style="text-align: left; width: 8%;" class="table-header">
                                                        <h7><?= label('BatchNo') ?> </h7>
                                                    </th>
                                                    <th style="text-align: left; width: 8%;" class="table-header">
                                                        <h7><?= label('Packed') ?> </h7>
                                                ...
                                                if ($lxzmm['expi'] == 1) {
                                                ?>
                                                    <th style="text-align: left;" class="table-header">
                                                        <h7>MRP</h7>
                                                    </th>
                                                <?php } ?>
                                                <th style=" width: 8%;"><?= label('MRP') ?> </th>
                                                <th style="text-align: left; width: 8%;" class="table-header">
                                                    <h7><?= label('Dis Amt') ?> </h7>
                                                </th>
                                                <th style="text-align: left; display: none;" class="table-header">
                                                    <h7><?= label('Dis%') ?> </h7>
                                                </th>
                                                <th style="text-align: left; width: 8%;" class="table-header">
                                                    <h7><?= label('Agent%') ?> </h7>
                                        ...
                                        <tbody id="productListkar" style="width: 100% !important;">
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                            <div>
                                <div class="row mb-2" style="margin-top: 20px; display:flex; align-items:center;">
                                    <div class="col-md-4"></div>
                                    <div class="col-md-1"><?= label('Pre-Tax') ?></div>
                                    <div class="col-md-1"><input type="text" name="pre_tax" class="form-control" readonly id="pre_tax"></div>
                                    <div class="col-md-1"><?= label('TotalItems') ?></div>
                                    <div class="col-md-1">
                                        <input readonly="readonly" type="text" class="form-control" id="discct" name="discct" value="" placeholder="Total">
                                    </div>
                                    <div class="col-md-1"><?= label('Total') ?></div>
                                    <div class="col-md-3">
                                        <input readonly="readonly" type="text" class="form-control" id="betot" name="betot" value="" placeholder="Total">
                                        <input readonly="readonly" type="hidden" class="form-control" id="get_betot" name="get_betot" value="0" placeholder="Total">
                                    </div>
                                </div>
                                <?php
                                if ($lxzmm['gst_tax'] == 1) { ?>
                                    <div class="row" style="margin-top: 15px; display:none; align-items:center;">
                                        <div class="col-md-8"></div>
                                        <div class="col-md-1"><?= label('CGST') ?> </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row" style="margin-top: 15px; display:none; align-items:center;">
                                        ...
                                        <div class="col-md-8"></div>
                                        <div class="col-md-1"><?= label('SGST') ?> </div>
                                        <div class="col-md-3">
                                            <input style="width: 80px;" readonly="readonly" type="text" class="form-control" id="sskgst" name="sskgst" value="" placeholder="">
                                        <?php } else { ?>
                                            <input style="width: 80px;" readonly="readonly" type="hidden" class="form-control" id="cskgst" name="cskgst" value="0" placeholder="Total">
                                            <input style="width: 80px;" readonly="readonly" type="hidden" class="form-control" id="sskgst" name="sskgst" value="0" placeholder="">
                                        <?php } ?>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-bordered" style="margin-top: 10px;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="2">Agent Comission</th>
                                                <th colspan="2">Freight Costs</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>CGST</td>
                                                <td>
                                                    <input type="text" name="_cgst" id="_cgst" style="border: none;width: 80px;" value="0" readonly>
                                                    <input readonly="readonly" type="text" class="form-control" id="cskgst" name="cskgst" style="display: none;" value="" placeholder="Total">
                                                </td>
                                                <td>Dis Amt</td>
                                                <td>
                                                    <input type="text" class="form-control" id="total_invoice_discount_amount" name="total_invoice_discount_amount" value="0" placeholder="">
                                                    <input onkeyup="return callds(this.value,this.id);" type="text" class="form-control" id="ddkst" name="ddkst" value="0" style="display: none;" placeholder="">
                                                </td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td>SGST</td>
                                                <td><input type="text" name="_sgst" id="_sgst" style="border: none;width: 80px;" value="0" readonly>
                                                </td>
                                                <td>Dis %</td>
                                                <td><input type="text" class="form-control" id="total_invoice_discount_percentage" name="total_invoice_discount_percentage" value="0" placeholder=""></td>
                                                <td>Agent %</td>
                                                <td>
                                                    <input type="hidden" class="form-control" id="agent_commission_amount" name="agent_commission_amount" value="0">
                                                    <input type="text" class="form-control" id="agent_commission" name="agent_commission" value="0" placeholder="Agent Commission">
                                                </td>
                                                <td>Freight Cost</td>
                                                <td><input type="text" class="form-control" id="freight_cost" name="freight_cost" value="0" placeholder="Freight Cost"></td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                <td>IGST</td>
                                                <td>
                                                    <input type="text" name="_igst" id="_igst" style="border: none;width: 80px;" value="0" readonly>
                                                </td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                ...
                                                <td></td>
                                                <td>Final Total</td>
                                                <td><input readonly="readonly" type="text" class="form-control" id="afftot" name="afftot" value="" placeholder="Total"></td>
                                            </tr>
                                            <tr>
                                                <td>Tax Total</td>
                                                <td>
                                                    <input type="hidden" name="_gst" id="_gst" style="border: none;" value="0" readonly>
                                                    <input type="hidden" name="taxtotal" id="taxtotal">
                                                    <input type="text" name="_tax_total" id="_tax_total" style="border: none;" value="0" readonly>
                                                </td>
                                                <td colspan="8"></td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div class="row" style="margin-top: 15px; display:flex; align-items:center; margin-bottom: 10px;">
                                        <div class="col-md-9"></div>
                                        <div class="col-md-3"><br><input type="Submit" class="form-control btn btn-green" id="aftot" name="Submit" value="Save" onclick="callcctt_fibnal();"></div>
                                    </div>
                            </div>
        ...
        <script>
            $(document).ready(function() {
                // $('#pur_pro_table').DataTable();
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('pos/load_posalesmsk') ?>",
                    data: {
                        producnum: 10
                    },
                    dataType: "html",
        ...
        <script>
            function agent_commission(no) {
                var agent_commission_percent = Number($('#agent_commission').val());
                var pur_price = Number($('#cosst_' + no).val());
                var product_qty = Number($("#qty_" + no).val());
                var commission = (pur_price * product_qty) / 100 * agent_commission_percent;
                $("#agent_commission_" + no).val(commission);
                return commission;

            }
            $('#total_invoice_discount_amount').keyup(function(e) {
                var total = $('#get_betot').val();
                var total_invoice_discount_amount = $(this).val();
                var cal_percent = total_invoice_discount_amount / total * 100;
                $('#total_invoice_discount_percentage').val((cal_percent).toFixed(2));
                var betot = Math.round(total - total_invoice_discount_amount);
                var tax_total = Number($('#_tax_total').val());

                //$('#betot').val(betot);
                var cskgst = Number($('#cskgst').val());
                var sskgst = Number($('#sskgst').val());
                var tax_total = Number($('#_tax_total').val());
                var grand_total = betot;
                var freight_cost = Number($('#freight_cost').val());
                var agent_commission_percent = Number($('#agent_commission').val());
                var agent_commission = total / 100 * agent_commission_percent;
                grand_total = grand_total + freight_cost + agent_commission;
                $('#afftot').val(grand_total);
            });

            $('#freight_cost').keyup(function(e) {
                var total = $('#get_betot').val();
                var total_invoice_discount_amount = $('#total_invoice_discount_amount').val();
                var cal_percent = total_invoice_discount_amount / total * 100;
                $('#total_invoice_discount_percentage').val((cal_percent).toFixed(2));
                var betot = Math.round(total - total_invoice_discount_amount);
            ...
            $('#agent_commission').keyup(function(e) {
                var total = $('#get_betot').val();
                var total_invoice_discount_amount = $('#total_invoice_discount_amount').val();
                var cal_percent = total_invoice_discount_amount / total * 100;
                $('#total_invoice_discount_percentage').val((cal_percent).toFixed(2));
                ...
                $('input[name^="qty"]').each(function() {
                    ...
                    var no = ($(this).attr('no'));
                    commission += agent_commission(no);
                    // var commission = (pur_price * product_qty) / 100 * agent_commission_percent;
                    // $('#agent_commission_' + no).val(agent_commission.toFixed(2));
                });
                grand_total = grand_total + freight_cost + commission;
                $('#afftot').val(grand_total);


            });

            $('#total_invoice_discount_percentage').keyup(function(e) {
                var total = $('#get_betot').val();
                var total_invoice_discount_percentage = $(this).val();
                var total_invoice_discount = total / 100 * total_invoice_discount_percentage;
                $('#total_invoice_discount_amount').val((total_invoice_discount).toFixed(2));
                var betot = Math.round(total - total_invoice_discount);
                $('#betot').val(betot.toFixed(2));
                var cskgst = Number($('#cskgst').val());
                var sskgst = Number($('#sskgst').val());
                var tax_total = Number($('#_tax_total').val());
                var grand_total = betot;
        ...
        <script type="text/javascript">
            ...
            function barcodekar() {
                ...
                // if (taxtype == '' || taxtype == 0 || taxtype == '0') {
                //     $('#taxtype').focus();
                //     return false;
                // }
                ...
                var _category = $("#category_").val();
                var alert_qty = $('#alert_qty_').val();
                var sel_dis = $('#sel_dis').val();
            ...
            function calculatePurchase() {
                ...
                if (ss != '') {
                    for (var i in ss) {
                        ...
                        if (i < 5) {
                            ...
                            $('.table-container').attr('style', 'height: ' + height + 'px; overflow: hidden;');
                        }
                        xt = ss[i];
                        var _cgst = $('#_cgst_' + xt).val();
                        total_cgst += parseFloat(_cgst);
                        var _sgst = $('#_sgst_' + xt).val();
                        total_sgst += parseFloat(_sgst);
                        var _igst = $('#_igst_' + xt).val();
                        total_igst += parseFloat(_igst);
                        var _gst = $('#_gst_' + xt).val();
                        total_gst += parseFloat(_gst);

                        all_tax_total += parseFloat($('#taxtotal_' + xt).val());
                        var elementExists = document.getElementById('subtt_' + xt);
                        if (elementExists != null) {
                            var rssss = document.getElementById('subtt_' + xt).value;
                            var xxz = document.getElementById('qty_' + xt).value;
                            ...
                            c1 = Number(document.getElementById('cgst_' + xt).value);
                            ...
                            $("#ttcgst_" + xt).val(tty);
                            cc1 = parseFloat(cc1) + parseFloat(tty);
                            s1 = Number(document.getElementById('sgst_' + xt).value);
                            var sty = (parseFloat(s1) * parseFloat(rssss)) / 100;
                            $("#ttsgst_" + xt).val(sty);
                            ss1 = parseFloat(ss1) + parseFloat(sty);
                        }
                ...
                $('#_cgst').val(parseFloat(total_cgst.toFixed(2)));
                $('#_sgst').val(parseFloat(total_sgst.toFixed(2)));
                $('#_igst').val(parseFloat(total_igst.toFixed(2)));
                $('#_gst').val(parseFloat(total_gst.toFixed(2)));
                $('#_tax_total').val(parseFloat(all_tax_total.toFixed(2)));
                //console.log(all_tax_total);

                // $("#total_invoice_discount_amount").val(total_dicount.toFixed(2));
                // $("#total_invoice_discount_percentage").val(total_percentage.toFixed(2));
                var ccrt1 = parseFloat(cc1) / 2 / 10;
                var dd1 = document.getElementById('ddkst').value;
                // + parseFloat(ss1) + parseFloat(cc1)
                ...
                var flss1 = parseFloat(amtt) - parseFloat(dd1);
                $("#discct").val(totitem.toFixed(2));
                <?php if ($lxzmm['gst_tax'] == 1) { ?>

                    $("#cskgst").val(ccrt1.toFixed(2));
                    $("#sskgst").val(ss1.toFixed(2));
                    // flss1 = parseFloat(ss1) + parseFloat(cc1);
                <?php } ?>
                $("#afftot").val(Math.round(flss1));
                $('#pre_tax').val(Math.round(flss1 - all_tax_total));
                // $("#countryname_" + focus_id).focus();
                // $("#countryname_" + focus_id).attr('style', 'padding-bottom: 30px;');
        ...
        <script type="text/javascript">
            ...
            function calpur_price() {
                var va1 = document.getElementById('cosst_1m').value;
                var va2 = document.getElementById('qty_1m').value;
                var kmxx = parseFloat(va1) * parseFloat(va2);
                $("#subtt_1m").val(kmxx.toFixed(2));
            ...
            function auromcv(kk, mm) {
                ...
                $('#countryname_' + jjv).autocomplete({
                    ...
                    select: function(event, ui) {
                        ...
                        $('#cosst_1m_calculate').val(names[3]);
                    }
                });
