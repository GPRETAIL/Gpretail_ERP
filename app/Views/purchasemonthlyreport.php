<div class="container">
   ...
   <h3><?=label('Monthly');?> <?=label('Purchase');?> <?=label('Report');?>     </h3>
   <hr>
   <div class="row rangeStat" style="margin-top:3px;">
      <div class="col-sm-2 ">
  <div class="form-group"><?=label('Fromdate');?>
  <input type="text" maxlength="30" Required="required"  value="" name="pddate" class="form-control" id="pddate" placeholder="from Date">
  ...
  <div class="form-group"><?=label('Tilldate');?>
     <input class="form-control" type="text" name="innvdda" id="innvdda" value="" placeholder="Till Date">
