<?php
// app/Views/cash_in_hand_daily.php
?>
...
<table id="chltkarr" class="table table-striped table-bordered" cellspacing="0" width="100%">
    <tr style="background:#1c76bc;color:#fff;border: 1px solid #1c76bc;">
        ...
        <th style="border: 1px solid #1c76bc;"> <?= label("Total Cancelled") ?> (D)</th>
        <th style="border: 1px solid #1c76bc;"> <?= label("Paid Cancelled") ?> (E)</th>
    ...
    <tr>
        <td style="text-align:center;border: 1px solid #1c76bc;"> <?= esc($start) ?> </td>
