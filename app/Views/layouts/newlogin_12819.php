...
<html >
  ...
  <?php 
   ...
   if(emaa=='')
   {
   	document.getElementById("emaa").focus();
   	return false; 
   }
   ...
   $.ajax({
         url : "http://chltech.in/retailenc/login/capcl",
         type: "POST",
         data: {idd:idd,namm:namm,emaa:emaa,mobilee:mobile},
...
<input required="required"  type="text" id="namee" autofocus name="namee" value="" placeholder="Name" required>
<input required="required"  type="text" id="mobile"  name="mobile" value="" placeholder="Mobile Number" required>
<input class="sdsd"  required="required"  type="email" id="emailid"  name="emailid" value="" placeholder="Email" required>
