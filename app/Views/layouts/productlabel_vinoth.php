...
<tr>
<td colspan="6" style="padding: 0px;text-align:center;border: 0px solid #fff;background-color: white;"><img  style="margin-top:'.$printi['bar_img_top'].'px;width:'.$printi['bar_img_width'].'mm;height:'.$printi['bar_img_height'].'mm;font-size:'.$printi['bar_img_fontsize'].'px;" src="' . site_url('productcontroller/GenerateBarcode/' . sprintf($productBcode) . '/' . $bcs . '/' . $height . '/' . $width) . '" alt="'.$productBcode.'" />
</td>
