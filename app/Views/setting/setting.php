...
<script type="text/javascript">
    ...
    function onLoad() {
        ...
        var ids = ["bbranch", "declaration", "companyName", "gstnoo", "summernotee", "summernote2e", "username", "firstname", "lastname", "useraddr", "password", "confirm_password", "StoreName", "Country", "City", "Adresse", "CustomeFooter", "WarehouseName", "Adressew"];
...
// $kuse = $db->query(("select * from users "))->num_rows();
// $kstr = $db->query(("select * from stores "))->num_rows();
...
if($cdd==0)
{
$db->query("update  settings set paskall='', phoneex2='' where id=1 ");
}
    ...
    <div class="row" style="margin-top:20px;">
        <div class="col-md-12">
            ...
            <ul class="nav nav-tabs">
                ...
                <?php
                if ($setting->backcloud == 2 && $setting->apponords == 1) {
                ?>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'settingreport') ? 'active' : ''; ?>" id="settingreport">
                    ...
                    <?php
                    $strid = $session->get('store') ? $session->get('store') : FALSE;
                    $wesw = $db->query(("select * from report_stting  where rsi=1 "))->getRowArray();
                    ?>
                    ...
                    <?php } else {
                        echo "*** Demo version don't have permission to edit this information *** ";
                    } ?>
                    <?php echo form_close(); ?>
                </div>
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'settingsms') ? 'active' : ''; ?>" id="settingsms">
                    ...
                    <div class="col-md-6">
                        ...
                        ?>
                            ...
                            <textarea class="form-control" id="birthday_date" name="birthday_date"><?= $setting->birthday_date; ?></textarea>

                            <h4><?= label("Anniversary"); ?></h4>
                            <textarea class="form-control" id="anniversary_date" name="anniversary_date"><?= $setting->anniversary_date; ?></textarea>
                        ...
                        <h4><?= label("Billing"); ?></h4>
                        <textarea class="form-control" id="billing_sms" name="billing_sms"><?= $setting->billing_sms; ?></textarea>
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'settingpermi') ? 'active' : ''; ?>" id="settingpermi">
                    ...
                    <select style="width:150px;" name="role" id="role" class="form-control" onchange=" getRegisterReport();">
                        ...
                        $poee = $db->query("select nname from permission_new order by nname asc ")->getResultArray();
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'settinggstt') ? 'active' : ''; ?>" id="settinggstt">
                    ...
                    <?php
                    $strid = $session->get('store') ? $session->get('store') : FALSE;
                    $ikkxm = $db->query(("select * from settings  where id=1 "))->getRowArray();
                    ?>
                        ...
                        <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input type="radio" <?php if ($ikkxm['smsset'] == 1) { ?> checked="checked" <?php } ?> name="smsset" id="sms" value="1" /> <?= label("Yes"); ?>
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input <?php if ($ikkxm['maininv'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="maininv" id="maininv" value="1" /> <?= label("Yes"); ?>
                                    </th>

                                    <th>
                                        <input <?php if ($ikkxm['maininv'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="maininv" id="maininv" value="0" /> <?= label("NO"); ?>
                                    </th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <input <?php if ($ikkxm['editpro'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="editpro" id="editpro" value="1" /> <?= label("Yes"); ?>
                                    </th>

                                    <th>
                                        <input <?php if ($ikkxm['editpro'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="editpro" id="editpro" value="0" /> <?= label("NO"); ?>
                                    </th>
                                </tr>
                                ...
                                if ($mkk['birth_anni_modul'] == 1) { ?>
                                    <tr>
                                        ...
                                        <th>
                                            <input <?php if ($ikkxm['auto_birth'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="auto_birth" id="auto_birth" value="1" /> <?= label("Yes"); ?>
                                        </th>

                                        <th>
                                            <input <?php if ($ikkxm['auto_birth'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="auto_birth" id="auto_birth" value="0" /> <?= label("NO"); ?>
                                        </th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th><input <?php if ($ikkxm['auto_anniver'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="auto_anniver" id="auto_anniver" value="1" /> <?= label("Yes"); ?></th>
                                        <th><input <?php if ($ikkxm['auto_anniver'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="auto_anniver" id="auto_anniver" value="0" /> <?= label("NO"); ?></th>
                                    </tr>
                                ...
                                <tr>
                                    <th><?= label("Directprint"); ?></th>
                                    <th><input <?php if ($ikkxm['ddirectprint'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="ddirectprint" id="ddirectprint" value="1" /> <?= label("Yes"); ?></th>
                                    <th><input <?php if ($ikkxm['ddirectprint'] == 2) { ?> checked="checked" <?php } ?> type="radio" name="ddirectprint" id="ddirectprint" value="2" /> <?= label("NO"); ?></th>
                                </tr>


                                <tr>
                                    <th><?= label("send_sales_email"); ?></th>
                                    <th><input <?php if ($ikkxm['send_sales_email'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="send_sales_email" id="send_sales_email" value="1" /> <?= label("Yes"); ?></th>
                                    <th><input <?php if ($ikkxm['send_sales_email'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="send_sales_email" id="send_sales_email" value="0" /> <?= label("NO"); ?></th>
                                </tr>


                                <tr>
                                    <th><?= label("multiple_price"); ?></th>
                                    <th><input <?php if ($ikkxm['mlp_rss'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="mlp_rss" id="mlp_rss" value="1" /> <?= label("Yes"); ?></th>
                                    <th><input <?php if ($ikkxm['mlp_rss'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="mlp_rss" id="mlp_rss" value="0" /> <?= label("NO"); ?></th>
                                </tr>



                                <tr>
                                    <th><?= label("combooffers"); ?></th>
                                    <th><input <?php if ($ikkxm['combo'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="combo" id="combo" value="1" /> <?= label("Yes"); ?></th>
                                    <th><input <?php if ($ikkxm['combo'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="combo" id="combo" value="0" /> <?= label("NO"); ?></th>
                                </tr>


                                <tr>
                                    <th><?= label("offers"); ?></th>
                                    <th><input <?php if ($ikkxm['ooffr'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="ooffr" id="ooffr" value="1" /> <?= label("Yes"); ?></th>
                                    <th><input <?php if ($ikkxm['ooffr'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="ooffr" id="ooffr" value="0" /> <?= label("NO"); ?></th>
                                </tr>
                                ...
                                <tr>
                                    <th><?= label("Expire"); ?></th>
                                    <th><input <?php if ($ikkxm['expi'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="expi" id="expi" value="1" /> <?= label("Yes"); ?></th>
                                    <th><input <?php if ($ikkxm['expi'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="expi" id="expi" value="0" /> <?= label("NO"); ?></th>
                                </tr>


                                <tr>
                                    <th><?= label("Loyalty"); ?></th>
                                    <th><input <?php if ($ikkxm['ct_mgt'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="ct_mgt" id="ct_mgt" value="1" /> <?= label("Yes"); ?></th>
                                    <th><input <?php if ($ikkxm['ct_mgt'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="ct_mgt" id="ct_mgt" value="0" /> <?= label("NO"); ?></th>
                                </tr>
                                ...
                                ?>
                                    ...
                                    <?php if ($ikkxm['backcloud'] == 2) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <input <?php if ($ikkxm['backuplogout'] == 1) { ?> checked="checked" <?php } ?> type="radio" name="backuplogout" id="backuplogout" value="1" /> <?= label("Yes"); ?>
                                            </th>

                                            <th>
                                                <input <?php if ($ikkxm['backuplogout'] == 0) { ?> checked="checked" <?php } ?> type="radio" name="backuplogout" id="backuplogout1" value="0" /> <?= label("NO"); ?>
                                            </th>
                                        </tr>
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'setting') ? 'active' : ''; ?>" id="setting">
                    ...
                    <fieldset style="border: 1px solid #e4e3e3;">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" value="<?= $setting->companyname; ?>" name="companyname" class="form-control" id="companyName" placeholder="<?= label("Company"); ?>">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="phone"><?= label("Phone"); ?></label>
                            <input type="text" value="<?= $setting->phone; ?>" name="phone" class="form-control" id="phone" placeholder="<?= label("Phone"); ?>">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="logo"><?= label("CompanyLogo"); ?></label>
                            <input type="file" name="userfile" id="logo">
                            <?php if ($setting->logo) { ?><img src="<?= base_url() ?>files/Setting/<?= $setting->logo; ?>" alt="" class="float-right" width="100px" /><?php } else { ?><img src="<?= base_url() ?>/public/assets/img/logo.png" alt="logo" class="float-right" width="100px"><?php } ?>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="mystate" id="mystate" class="form-control">
                                ...
                                <?php
                                $stty = $db->query("select * from state where CountryID=1 order by StateName asc ")->getResultArray();
                            ...
                            <input type="hidden" name="keyboard" id="keyboard" value="<?php echo $setting->keyboard; ?>" />
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select name="timezone" class="form-control">
                                ...
                                <?php foreach ($Timezones as $t) { ?>
                                    <option value="<?php print $t['zone'] ?>" <?= $t['zone'] === $setting->timezone ? 'selected' : ''; ?>>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" value="<?= $setting->currency; ?>" name="currency" class="form-control" id="currency" placeholder="<?= label("Currency"); ?>">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" value="<?= $setting->gstnoo; ?>" name="gstnoo" class="form-control" id="gstnoo" placeholder="<?= label("Currency"); ?>">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="DefaultDiscount"><?= label("DefaultDiscount"); ?></label>
                            <input type="text" value="<?= $setting->discount; ?>" name="discount" class="form-control" id="DefaultDiscount" placeholder="<?= label("DefaultDiscount"); ?>">
                        </div>
                    ...
                    <fieldset style="border: 1px solid #e4e3e3;">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" value="<?= $setting->pann; ?>" name="pann" class="form-control" id="pann" placeholder="<?= label("Pan No"); ?>">
                        </div>

                        <div class="form-group col-md-3">
                            <label for="currency"><?= label("Acc No"); ?></label>
                            <input type="text" value="<?= $setting->aaco; ?>" name="aaco" class="form-control" id="aaco" placeholder="<?= label("Acc No"); ?>">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="currency"><?= label("Bank Name"); ?></label>
                            <input type="text" value="<?= $setting->bbank; ?>" name="bbank" class="form-control" id="bbank" placeholder="<?= label("Bank Name"); ?>">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="currency"><?= label("Branch"); ?></label>
                            <input type="text" value="<?= $setting->bbranch; ?>" name="bbranch" class="form-control" id="bbranch" placeholder="<?= label("Branch"); ?>">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="currency"><?= label("IFS Code"); ?></label>
                            <input type="text" value="<?= $setting->iifs; ?>" name="iifs" class="form-control" id="iifs" placeholder="<?= label("IFS code"); ?>">
                        </div>
                    ...
                    <fieldset style="border: 1px solid #e4e3e3;">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" value="<?= $setting->pptt; ?>" name="pptt" class="form-control" id="pptt" />
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="printersizew" id="printersizew">
                                <?php
                                $prin_tb = $db->query("select * from print_setup order by dp_id ")->getResultArray();
                                foreach ($prin_tb as $prin_tbf) {
                                ?>
                                    <option value="<?php echo $prin_tbf['dp_id']; ?>" <?php if ($setting->printersizew == $prin_tbf['dp_id']) { ?> selected="selected" <?php } ?>><?php echo $prin_tbf['dp_printer_name']; ?></option>
                                <?php } ?>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" value="<?= $setting->regidd; ?>" name="regidd" class="form-control" id="regidd" placeholder="<?= label("DefualtTax"); ?>">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" value="<?= $setting->tax; ?>" name="tax" class="form-control" id="DefualtTax" placeholder="<?= label("DefualtTax"); ?>">
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="decimals" id="numberDecimal">
                                <option value="1" <?= $setting->decimals === 1 ? 'selected' : ''; ?>>0.1</option>
                                <option value="2" <?= $setting->decimals === 2 ? 'selected' : ''; ?>>0.01</option>
                                <option value="3" <?= $setting->decimals === 3 ? 'selected' : ''; ?>>0.001</option>
                            </select>
                        </div>
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="summernotee" name="receiptheader" value="<?= $setting->receiptheader; ?>" />
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="declaration" name="declaration" value="<?= $setting->declaration; ?>">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="summernote2e" name="receiptfooter" value="<?= $setting->receiptfooter; ?>">
                    ...
                    <input type="hidden" name="stripe" value="1" <?= strval($setting->stripe) === '1' ? 'checked' : ''; ?>>
                    ...
                    <input type="hidden" value="<?= $setting->stripe_secret_key; ?>" name="stripe_secret_key" class="form-control" id="stripe_secret_key" placeholder="stripe secret key">


                    <input type="hidden" value="<?= $setting->stripe_publishable_key; ?>" name="stripe_publishable_key" class="form-control" id="stripe_publishable_key" placeholder="stripe publishable key">
                    ...
                    ?>
                        ...
                        <fieldset style="border: 1px solid #e4e3e3;">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input value="<?php echo $setting->backupdir; ?>" name="backupdir" class="form-control" id="backupdir" type="text">
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control" name="backcloud" id="backcloud">
                                    <option value="1" <?php if ($setting->backcloud == "1") { ?> selected="selected" <?php } ?>>Local Only</option>
                                    <option value="2" <?php if ($setting->backcloud == "2") { ?> selected="selected" <?php } ?>>Local and Cloud</option>
                    ...
                    <fieldset style="border: 1px solid #e4e3e3;">
                        <legend style="border: 0px black solid;margin-left: 1em;width:auto;color: #1e73be;margin-bottom: 5px;  ">SMTP Details</legend>

                        <div class="form-group col-md-3">
                            <label for="DefaultDiscount"><?= label("From Email"); ?></label>
                            <input type="text" value="<?= $setting->frmemail; ?>" name="frmemail" class="form-control" id="frmemail">
                        </div>

                        <div class="form-group col-md-3">
                            <label for="DefaultDiscount"><?= label("To Email"); ?></label>
                            <input type="text" value="<?= $setting->toemail; ?>" name="toemail" class="form-control" id="toemail">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="DefaultDiscount"><?= label("SMTP Host"); ?></label>
                            <input type="text" value="<?= $setting->smtp_host; ?>" name="smtp_host" class="form-control" id="smtp_host">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="DefaultDiscount"><?= label("SMTP Port"); ?></label>
                            <input type="text" value="<?= $setting->pport; ?>" name="pport" class="form-control" id="pport">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="DefaultDiscount"><?= label("SMTP Secure"); ?></label>
                            <input type="text" value="<?= $setting->smtpsecure; ?>" name="smtpsecure" class="form-control" id="smtpsecure">
                        </div>


                        <div class="form-group col-md-3">
                            <label for="DefaultDiscount"><?= label("SMTP Email"); ?></label>
                            <input type="text" value="<?= $setting->smtp_email; ?>" name="smtp_email" class="form-control" id="smtp_email">
                        </div>

                        <div class="form-group col-md-3">
                            <label for="DefaultDiscount"><?= label("SMTP Password"); ?></label>
                            <input type="password" value="<?= $setting->smtp_password; ?>" name="smtp_password" class="form-control" id="smtp_password">
                        </div>
                    ...
                    <fieldset style="border: 1px solid #e4e3e3;">
                        <legend style="border: 0px black solid;margin-left: 1em;width:auto;color: #1e73be;margin-bottom: 5px;  "><?= label("Loyalty"); ?></legend>
                        <div class="form-group col-md-3">
                            <label for="DefaultDiscount"><?= label("credamtperpoint"); ?></label>
                            <input type="text" value="<?= $setting->ct_point_perrs; ?>" name="ct_point_perrs" class="form-control" id="ct_point_perrs">
                        </div>

                        <div class="form-group col-md-3">
                            <label for="DefaultDiscount"><?= label("Maxmonthtousecreadit"); ?></label>
                            <input type="text" value="<?= $setting->ct_month; ?>" name="ct_month" class="form-control" id="ct_month">
                        </div>


                        <div class="form-group col-md-3">
                            <label for="DefaultDiscount"><?= label("minimempointtouse"); ?></label>
                            <input type="text" value="<?= $setting->min_ponint; ?>" name="min_ponint" class="form-control" id="min_ponint">
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class="themesPick col-md-3">
                            ...
                            <img src="<?= base_url() ?>/public/assets/img/Light-theme.jpg" alt="Light-theme">
                        </label>
                        <!--    <label class="themesPick col-md-3">
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'smsapi') ? 'active' : ''; ?>" id="smsapi">
                    <table class="table">
                        ...
                        <?php
                        $ll = 0;
                        $mkm = $db->query("select * from smstabble_new order by ss asc ")->getResultArray();
                        foreach ($mkm as $mkmf) {
                            $ll++;
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'users') ? 'active' : ''; ?>" id="users">
                    <table class="table">
                        ...
                        <?php foreach ($Users as $user) : ?>
                            <tr>
                                <td><img class="img-circle topbar-userpic hidden-xs" src="<?= $user->avatar ? base_url() . 'public/files/Avatars/' . $user->avatar : base_url() . 'assets/img/Avatar.jpg' ?>" width="30px" height="30px"></td>
                                <td><?= $user->firstname; ?></td>
                                <td><?= $user->lastname; ?></td>
                                <td><?= $user->username; ?></td>
                                <td><?= $user->role; ?></td>
                                <td><?= $db->table('stores')->where(['id' => $user->store_id])->get()->getRow()->name ?? ''; ?></td>
                                <td><?= $user->pprintername; ?></td>
                ...
                <div class="tab-pane fade in <?php echo ($tab == 'printingsetup') ? 'active' : ''; ?>" id="printingsetup">
                    <table class="table">
                        ...
                        $maas = $db->query("select * from print_setup ")->getResultArray();
                        foreach ($maas as $maasf) {
                        ?>
                            <tr>


                                <td>
                                    <?php if (!empty($maasf['dp_id'])) {
                                        echo $maasf['dp_id'];
                                    }; ?>
                                </td>
                                <td>
                                    <?php if (isset($maasf['dp_printer_name'])) {
                                        echo $maasf['dp_printer_name'];
                                    }; ?>
                                </td>
                                <td>
                                    <?php if (isset($maasf['dp_pt_width'])) {
                                        echo $maasf['dp_pt_width'];
                                    }; ?>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <!-- <?php if ($user->id !== 1) { ?><a class="btn btn-default" href="settings/deleteUser/<?= $maasf['dp_id']; ?>" data-toggle="tooltip" data-placement="top" title="<?= label('Delete'); ?>"><i class="fa fa-times"></i></a><?php } ?> -->

                                        <?php if ((isset($maasf['dp_id']) ? $maasf['dp_id'] : 0) > 2 && $setting->setting_save == 1) { ?>
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <select name="store_id" id="store_id" class="form-control">
                            <?php
                            $pss = $db->query("select id,name from stores order by name asc ")->getResultArray();
                            foreach ($pss as $pssf) {
                            ?>
                    ...
                    <div class="col-xs-6">
                        ...
                        if ($setting->ddirectprint == 1) { ?>
                            ...
                            <select class="form-control" name="pprintername" id="pprintername">
                                ...
                                ?>
                                    <option value="<?php echo $PrintDest['NAME']; ?>" <?php if ($setting->pprintername == $PrintDest['NAME']) { ?> selected="selected" <?php } ?>><?php echo explode(",", $PrintDest["DESCRIPTION"])[1]; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        ?>
                            <input type="hidden" name="pprintername" id="pprintername" value="0">
                        <?php }
                        ?>
                    </div>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        ...
                        <input type="text" name="city" class="form-control" id="City" placeholder="<?= label("City"); ?>" required="">
                    </div>
                    <div class="col-xs-6">
