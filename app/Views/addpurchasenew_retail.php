...
$("#innvamt").val(amtt.toFixed(2));
$("#discct").val(totitem.toFixed(2));
$("#cskgst").val(cc1.toFixed(2));
...
<h3><?=label("Add");?> <?=label("Purchase");?> <a style="float: right;" class="btn btn-primary btn-red" href="<?php echo base_url();?>purchase"  ><?=label("Back");?></a></h3>
<hr>
...
<div class="col-sm-2 ">
  <div class="form-group"><?=label("Store");?> 
     <select required="required" class="form-control" id="storrid" name="storrid" >
    
<?php
$mjms=mysql_query("select * from stores order by name asc ");
while($mjmfs=mysql_fetch_array($mjms))
{
   ?>
...
<div class="col-sm-2 ">
  ...
  <div class="form-group"><?=label("Suppliers");?> <?=label("Invoice");?> <?=label("Date");?> 
     <input required="required" class="form-control" type="text" name="innvdda" id="innvdda" value="<?php echo date("d-m-Y");?>" />
</div>
</div>  
 ...
 <div class="col-sm-12 ">
<div class="panel-body" style="padding: 1px;background-color: bisque;">
...
<select required="required" class="form-control" id="cattff" name="cattff">
  <option value="0" >Select </option>
<?php

$mjmc=mysql_query("select * from categories order by name asc ");
while($mjmcf=mysql_fetch_array($mjmc))
{
 ?>
...
<div class="col-sm-2 " style="padding-right: 1px;padding-left: 1px;">
<div class="form-group">
       <input autocomplete="off" onkeyup="return auromcv(this.value,this.id);" class="form-control" type='text' id='countryname_1m' '/>
...
if(purrs=='' || purrs=='0') { $('#cosst_1m').focus(); return false; }
...
var nj=atorr++;
   $.ajax({
         ...
         type: "POST",
         data: {lev_1m: lev_1m,rack_1m: rack_1m,producnum: producnum,purrs: purrs,sellrs: sellrs,qqty: qqty,cgstt: cgstt,sgst: sgst,toto: toto},
         success: function(data)
         {
...
function calpurc(cc,bb)
   ...
   function calsell(cc,bb)
   {
     ...
     $("#selling_1m").val(kmxx2.toFixed(2));
      ...
      <input type="text" class="form-control" id="cosst_1m"  value="" placeholder="Cost"><br>
     ...
     <?php
      ...
      { ?>
      <div  style="padding-right: 1px;padding-left: 1px;" class="col-sm-1 "><div class="form-group">
      <input  style="" readonly="readonly" type="text" class="form-control" id="cgst_1m"  value="" placeholder="tax">
      </div></div>
...
<input  style="padding: 0px 0px;"  type="hidden"    class="form-control" id="rack_1m"   value="1" placeholder="Rack">
      ...
      <div  class="col-sm-1 " style="padding-right: 1px;padding-left: 1px;"><div class="form-group">
      <input    type="text" readonly="readonly" class="form-control" id="selling_1m"  value="" placeholder="Cost"><br>
...
<div class="panel-body" style="padding: 1px;">
        ...
        if($lxzmm['gst_tax']==1)
        {
         ...
         <div style="text-align: left;" class="col-xs-2 table-header">
...
<div  class="col-xs-12" >
     ...
     ?>
      ...
      <div  class="col-sm-2 "><br><?=label("tax");?> <?=label("Amount");?></div>
      
      <div style="padding-left: 0px;padding-right: 0px;" class="col-sm-2 "><br><input readonly="readonly" type="text" class="form-control" id="cskgst" name="cskgst" value="" placeholder="Total"></div>  
...
<div  class="col-xs-12" >
     ...
     ?>
      ...
      <div style="padding-left: 0px;padding-right: 0px;" class="col-sm-2 "><br><input onkeyup="return callds(this.value,this.id);"  type="text" class="form-control" id="ddkst" name="ddkst" value="0" placeholder=""></div>  
...
<div  class="col-xs-12" >
      ...
      <div  class="col-sm-1 "></div><div class="col-sm-2 "></div>
     <?php
       if($lxzmm['gst_tax']==1)
      { ?>
      <div class="col-sm-1 "></div>
