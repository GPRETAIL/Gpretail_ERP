<div class="container">
    <div class="row" style="margin-top:3px;">
        <h3><?= label('Daily'); ?> <?= label('Purchase'); ?> <?= label('Reports'); ?> </h3>
        <hr>
        <div class="row rangeStat" style="margin-top:2px;">
            <div class="col-sm-2 ">
                <div class="form-group"><?= label('Fromdate'); ?>
                    <input type="text" maxlength="30" Required="required" value="<?php echo date("m/d/Y"); ?>" name="pddate" class="form-control" id="pddate" placeholder="from Date">
            ...
            <div class="col-sm-2 ">
                <div class="form-group"><?= label('Tilldate'); ?>
                    <input class="form-control" type="text" name="innvdda" id="innvdda" value="<?php echo date("m/d/Y"); ?>" placeholder="Till Date">
            ...
            <div class="col-md-2">
                ...
                <a href="javascript:void(0);" style="padding: 7px;margin-top: 22px;" class="btn btn-add hiddenpr" onclick="getProducttaxReport()"><?= label('GetReport'); ?></a>

                <a href="#" style="padding: 7px;margin-top: 22px;" class="btn btn-add hiddenpr" onclick="PrintTicket()">Print</a>
                <a href="#" id="btnExport" style="padding: 7px;margin-top: 22px;" class="btn btn-add hiddenpr">XLS</a>

                <a href="#" style="padding: 7px;margin-top: 22px;" class="btn btn-add hiddenpr" onclick="pdfreceipt()">PDF</a>
