  <div class="container">
      ...
      <h3><?= label("GoodsOut"); ?><?php if ($kkar['pra'] == 1) { ?><a style="float: right;" class="btn btn-primary btn-green" href="<?php echo base_url(); ?>goodsout/addgoodsout"><?= label("Add"); ?></a><?php } ?>
      ...
      <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
          <thead class="thead-inverse">
              <tr>
                  ...
                  <th><?= label("Reference"); ?> <?= label("Number"); ?> </th>
                  <th><?= label('Action'); ?></th>
              </tr>
          </thead>
          <tbody>
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="number" st/Required name="amount" class="form-control" id="Amount" placeholder="</?= label("Amount"); ?>">
                  </div>
                  <div class="form-group">
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function() {
          table = $('#table').DataTable({
              ...
              "ajax": {
                  "url": "<?php echo site_url('invoicesPur/ajaxListGoods') ?>",
                  "type": "POST"
              },
              "order": [
                  [1, "desc"]
      ...
      function showTicket(id) {
          ...
          $.ajax({
              url: "<?php echo site_url('invoicesPur/ShowTicketgoods') ?>/" + id,
              type: "POST",
              success: function(data) {
  ...
  <div class="modal fade" id="ticket" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document" id="ticketModal" style="width:600px;">
          <div class="modal-content">
              <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" id="ticket"><?= label("View"); ?></h4>
              </div>
              <div id="printSection">
                  <!-- Ticket goes here -->
                  <center>
