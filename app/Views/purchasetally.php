...
<div class="container">
   ...
   <h3>Purchase - Tally      </h3>
   <hr>
   <div class="row rangeStat" style="margin-top:2px;">


<form action="<?php echo base_url();?>log/updatepurchasetally" method="post" >
  <div class="col-sm-2 ">
   <div class="form-group">Company Name 
  <input type="text" required="required"     value="" name="comm" class="form-control" id="comm" placeholder="Company Name">
     </div>
  </div> 
...
<a href="#" id="btnExport" class="cancelBtn btn btn-picker"   style="background: #34495e;
color: #fff;border: 1px solid #34495e;display: inline;padding: 9px;margin-top: 13px;"  >XLS</a>

<input type="submit"  name="XML" style="background: #34495e;
color: #fff;border: 1px solid #34495e;display: inline;padding: 7px;margin-top: 14px;border-radius: 4px;"  value="XML"  />

<input type="submit" name="Update" style="background: #34495e;
color: #fff;border: 1px solid #34495e;display: inline;padding: 7px;border-radius: 4px;"  value="Update Tally"   />
   ...
   function getProducttaxReport()
   {
     var Range = $('#pddate').val();
      var Range1 = $('#innvdda').val();
        ...
        $.ajax({
            url : "<?php echo site_url('reports/getpurchasetallybb')?>/",
