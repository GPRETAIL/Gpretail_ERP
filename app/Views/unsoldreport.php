...
<div class="row rangeStat" style="margin-top:10px;">
      ...
      <div class="col-md-2">
         <div class="form-group">
             <label for="customerSelect"><?=label('Search By');?></label>
               <select class="js-select-options form-control" id="StoresSelect">
               <option value="1">By Quantity</option>
...
<a href="#"  style="padding: 7px;margin-top:25px;" class="btn btn-add hiddenpr" onclick="pdfreceipt()">PDF</a>
   </div>
  ...
  function getRegisterReport()
   {
     ...
     var ckkk = $('#ckkk').find('option:selected').val();
        ...
        $.ajax({
            url : "<?php echo site_url('reports/unsoldrackwar')?>/",
            type: "POST",
