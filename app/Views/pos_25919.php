...
<tr style=" " >
  ...
  <?php  if( $this->setting->disc_all ==1)
                  { ?>
                    ...
                    <td class="" style="text-align: center; width:12%;padding: 5px;font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;" ><b><?=label("Discount");?></b> (%)
...
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;" type="text" value="<?=$ssel_custds;?>" onkeyup="total_change()" id="<?=strval($this->setting->keyboard) === '1' ? 'num02' : ''?>" class="total-input Remise " placeholder="N/A"  >
                   ...
                   <?php } else {  ?>
                    <td class="" style="width:12%;padding: 14px;font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;" > &nbsp;
...
<input type="hidden" value="0" onchange="total_change()" id="<?=strval($this->setting->keyboard) === '1' ? 'num02' : ''?>" class="total-input Remise" placeholder="N/A"  maxlength="5">
                     ...
                     <?php } ?>
                      ...
                      <td class="" style="padding: 5px;text-align: center; font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;"  width="13%">
                       <b><?=label("Shipping");?></b>
...
<td class="" style="padding: 5px;text-align: center; font-family:'Roboto', sans-serif;border: 1px solid #ddd !important;"  width="15%"><b><?=label("paidcash");?>(F7)</b>
...
transition: border-color ease-in-out .15s,box-shadow ease-in-out .15s;"  type="text" name="mobnnm" class="-control" id="mobnnm" />
   ...
   <b><span style="margin-right: <?php echo $msk*7;?>%" class="float-right" ><span id="Subtot"   ></span></b>
      ...
      <?php }
            ...
            <h4 class="text-bold"><i style="color:#fff;" class="fa fa-money"></i> <?=label('PAYEMENT');?> (F2)</h4></button>

<a  onclick="saleBtn(1)" style="width: 31%;margin-left: 0.4%;border: 1px solid #B7B7B7 !important;"  href="javascript:void(0)"  class="btn btn-green col-md-4 flat-box-btn "><h4><i style="color:#fff;" class="fa fa-print"></i> <?=label('Quick Pay & Print');?> (F8)</h4> </a>
...
<a   onclick="saleBtn(1)" style="width: 56%;margin-left: 24%;margin-top: 4%;border: 1px solid #B7B7B7 !important;"  href="javascript:void(0)"  class="btn btn-green col-md-4 flat-box-btn "><h4><i style="color:#fff;" class="fa fa-print"></i> <?=label('Quick Pay & Print');?> (F8)</h4> </a>
...
$mnmz=($product->descountperr*$product->price)/100;
               ...
               <?php 
               ...
               else if($this->setting->destpp==2)
                {
                  ...
                  <div class="col-sm-3 col-xs-3" style="padding: 2px;">
                     <button style="width: 100%;border: 0px;padding-left: 0px;height: 140px;padding-right: 0px;background: transparent;border: 1px solid #dbdbdb;"    class="addPct" id="product-<?=$product->code;?>" onclick="add_posalenk('<?=$product->id;?>')">
                        <div class="product flat-box">
...
$pro_new_price=$product->price;
$orgprice=$product->price;


$pr_org_price =!$product->taxmethod || $product->taxmethod == '0' ? floatval($orgprice) : floatval($orgprice)*(1 + $tg / 100);
...
$product_price =!$product->taxmethod || $product->taxmethod == '0' ? floatval($pro_new_price) : floatval($pro_new_price)*(1 + $tg / 100);

?>

                  <div class="col-sm-12 " style="padding-right: 6px;padding-left: 1px;">
                     <a href="javascript:void(0)" class="addPct" id="product-<?=$product->code;?>" onclick="add_posalenk('<?=$product->id;?>')">
                        <div  style="   border: 1px solid #c8d3df;    background: linear-gradient(to bottom, #ffffff 0%,#eeeeee 100%);
    width: 100%;
    border-radius: 0px;
    text-align: left;
    ...
    overflow: hidden;">
<h3 style="margin-top: 7px;font-size: 15px;font-weight: bold; color: #000; margin-left: 5px;" id="proname"><?=$product->id;?>-<?=ucfirst($product->name);?>
  <?php
...
<span style="color:#489103;" >
  -Rs.<?=number_format((float)$product_price, $this->setting->decimals, '.', '');?></span>
...
{
?>
<span style="color:#489103;float: right;font-size: 10px;" ><?=$product->expire_1m;?></span>
<?php } ?>
