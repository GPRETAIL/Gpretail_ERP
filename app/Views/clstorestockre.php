<div class="container">
   ...
   <h3><?=label("Closing");?> <?=label('Stock');?> <?=label('Reports');?> -<?=label('Rack');?>    </h3>
   <hr>
  ...
  <div class="row rangeStat" style="margin-top:10px;">
      ...
      <a href="#" style="padding: 7px;    margin-top: 22px;"  class="btn btn-add hiddenpr" onclick="getRegisterReport()" ><?=label('Get');?></a>
  ...
  $('#pddate').datepicker({
               ...
               function getRegisterReport()
   {
      ...
      var endd = Range1.slice(6,10)+'-'+Range1.slice(3,5)+'-'+Range1.slice(0,2);
        ...
        $.ajax({
            url : "<?php echo site_url('reports/cclrtstore')?>/",
            type: "POST",
