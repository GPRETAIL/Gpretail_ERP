...
<div class="container">
    ...
    <div class="row" style="margin-top:3px;">
        <h3><?= label("Customer"); ?> <?= label("Reports"); ?> </h3>
        <hr>
        <div class="row rangeStat">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <select class=" js-select-options form-control " id="people" name="people">
                        <option>All</option>
                        <?php
    ...
    <script>
        ...
        var lineChartData = {
            ...
            datasets: [{
                    ...
                    data: [
                        <?= $monthlyExp->january ?? 0; ?>,
                        <?= $monthlyExp->feburary ?? 0; ?>,
                        <?= $monthlyExp->march ?? 0; ?>,
                        <?= $monthlyExp->april ?? 0; ?>,
                        <?= $monthlyExp->may ?? 0; ?>,
                        <?= $monthlyExp->june ?? 0; ?>,
                        <?= $monthlyExp->july ?? 0; ?>,
                        <?= $monthlyExp->august ?? 0; ?>,
                        <?= $monthlyExp->september ?? 0; ?>,
                        <?= $monthlyExp->october ?? 0; ?>,
                        <?= $monthlyExp->november ?? 0; ?>,
                        <?= $monthlyExp->december ?? 0; ?>
                    ]
                },
                {
                    label: "<?= label('Revenue'); ?>",
