<div class="container">
    <div class="col-md-12">
        ...
        <h3><?= label("Add"); ?> <?= label("combo_offers"); ?> <a style="float: right;" class="btn btn-primary btn-red" href="<?php echo base_url(); ?>productionentry"><?= label("Back"); ?></a></h3>
        <hr>
        <input type="hidden" id="countid" value="1">


        <form method="post" action="<?php echo base_url(); ?>combooffers/addtodbb">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-3 ">
                    <div class="form-group"><?= label("Title"); ?>
                        <input type="text" maxlength="30" Required="required" value="" name="ref" class="form-control" id="ref">
                    </div>
                </div>
            ...
            <div class="col-sm-10 ">
                <div class="panel-body" style="padding: 0px;background-color: bisque;">
                    ...
                    <div id="add1" class="col-xs-12">
                        ...
                        <div style="padding-right: 1px;padding-left: 1px;" class="col-sm-3 ">
                            <div class="form-group">
                        ...
                        <div class="col-sm-3 " style="padding-right: 1px;padding-left: 1px;">
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <button class="btn btn-success" type="button" onclick="barcodekar(0);">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div style="padding-left: 0px;padding-right: 0px;" class="col-sm-2 "><input type="text" class="form-control" id="final_amt" name="final_amt" value="" placeholder="Total">
                            </div>
