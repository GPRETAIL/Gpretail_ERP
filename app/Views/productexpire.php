<div class="container">
   ...
   <h3><?=label('Products');?> <?=label('expire');?> <?=label('Reports');?>     </h3>
   <hr>
  ...
  <div class="form-group"><?=label('Tilldate');?>
     <input class="form-control" type="text" name="innvdda" id="innvdda" value="<?php echo date("m/d/Y");?>" placeholder="Till Date">
      ...
      <div class="col-md-2">
         <button style="margin-top:17px;" class="cancelBtn btn btn-picker" type="button" onclick="getProducttaxReport()"><?=label('GetReport');?></button>
      </div>
 ...
 function PrintTicket() {
   ...
   function getProducttaxReport()
   {
      ...
      var Range1 = $('#innvdda').val();
        ...
        $.ajax({
            url : "<?php echo site_url('reports/getprodexpire')?>/",
