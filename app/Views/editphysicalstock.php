        ...
        <div class="col-md-12">
            ...
            <script>
                $(document).ready(function() {
                    $(document).on("click", "#addMoreRows", function() { //alert("ddssss");
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>purchase/addrowphy",
                            data: datastring,
                            cache: false,
            ...
            <script type="text/javascript">
                ...
                function callcc(cc, bb) {
                    ...
                    var jj = items[1];
                    var rssss = document.getElementById('cosst_' + jj).value;
                    var signn = document.getElementById('signn_' + jj).value;
                    var qqty = cc;
                    if (signn == "-") {
                        var kmxx = parseFloat(rssss) - parseFloat(qqty);
                    } else {
            ...
            <h3><?= label('Update Physical Stock'); ?><a style="float: right;" class="btn btn-primary btn-red" href="<?php echo base_url(); ?>PhysicalStock"><?= label('Back'); ?></a></h3>
            <hr>
            <input type="hidden" id="countid" value="1">


            <form method="post" action="<?php echo base_url(); ?>purchase/addtodbbphy">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group">&nbsp;&nbsp;<?= label('Voucher'); ?> <?= label('Number'); ?>
                            ...
                            $knn = isset($ikmm['id']) ? $ikmm['id'] + 1 : 0;
                            ?>
                            <input readonly="readonly" class="form-control" type="text" name="prcno" id="prcno" value="<?= esc($knn); ?>">
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group">&nbsp;&nbsp;<?= label('Store'); ?>
                            <select required="required" class="form-control" id="warr" name="warr">
                                ...
                                <?php
                                $mjm = $db->query("select * from stores order by name asc ")->getResult();
                                foreach ($mjm as $mjmf) {
                                ?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div style="width:90px;text-align: center;" class="col-xs-1 table-header">
                            <h7>Type</h7>
                        </div>

                        <div style="text-align: center;" class="col-xs-2 table-header">
                            <h7><?= label('Adjustment'); ?></h7>
                        </div>
                        <div style="width:120px;text-align: center;" class="col-xs-1 table-header">
                            <h7> <?= label('Reason'); ?></h7>
                        </div>
                        ...
                        <div style="text-align: center;" class="col-xs-2 table-header">
                            <h7><?= label('After'); ?> adj Qty</h7>
                        </div>
                        <div id="add1" class="col-xs-12">

                            <div class="col-sm-2 ">
                                <div class="form-group">
                                    <select onchange="getState(this.value,this.id)" class="js-select-options form-control" name="customerSelect[]" id="customerSelect_1">
                            ...
                            <div class="col-sm-2 ">
                                <div class="form-group">
                                    <select class="js-select-options form-control" id="statediv_1" name="statediv[]" onchange="getdetals(this.value,this.id)">
                                        ...
                                        // $kmkp = $db->table('products')->select('id, name')->where('id', $id)->get()->getResult();
                            ...
                            <div class="col-sm-1 ">
                                <div class="form-group">
                                    <select onchange="callcc_sigh(this.value,this.id);" class=" form-control" id="signn_1" style="padding: 0px 0px;" name="signn[]">
