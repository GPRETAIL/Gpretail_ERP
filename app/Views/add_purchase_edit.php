...
<div class="container">
        ...
        <div class="col-md-12" style="padding: 0px;padding-right: 1px;padding-left: 1px;">
            ...
            <script type="text/javascript">
                ...
                function remove_education_fields(rid) {
                    $.ajax({
                        url: "<?php echo site_url('pos/load_pogoodpurrdel/' . $id); ?>",
                        type: "POST",
                        dataType: 'html',
                        data: {
                            rid: rid
                ...
                function callcctt_fibnal(cc, bb) {
                    ...
                    if (innvamt != afftot) {
                        ...
                        var total_rows = $('#productListkar tr').length;
                        let rowsData = [];

                        $('#productListkar tr').each(function() {
                            let row = $(this);
                            let rowData = {
                                ats: row.find('input[name="ats[]"]').eq(0).val() || '',
                                producnum: row.find('input[readonly]').eq(0).val() || '',
                                branddd: row.find('select[name="branddd"]').val() || '',
                                category: row.find('select[name="_category_"]').val() || '',
                                prname: row.find('input[name="countryname[]"]').val() || '',
                                statediv: row.find('input[name="statediv[]"]').val() || '',
                                purrs: row.find('input[name="cosst[]"]').val() || '',
                                tttpye: row.find('input[name^="tttpye"]').val() || '',
                                taxtotal: row.find('input[name="taxtotal[]"]').val() || '',
                                cgstt: row.find('input[name="cgst[]"]').val() || '',
                                sgst: row.find('input[name="sgst[]"]').val() || '',
                                _cgst_: row.find('input[name="_cgst_[]"]').val() || '',
                                _sgst_: row.find('input[name="_sgst_[]"]').val() || '',
                                _gst_: row.find('input[name="_gst_[]"]').val() || '',
                                _igst_: row.find('input[name="_igst_[]"]').val() || '',
                                qqty: row.find('input[name="qty[]"]').val() || '',
                                batch_1m: row.find('input[name="batch[]"]').val() || '',
                                packed_1m: row.find('input[name="packed[]"]').val() || '',
                                expire_1m: row.find('input[name="expire[]"]').val() || '',
                                sellrs: row.find('input[name="selling[]"]').first().val() || '',
                                discount_amount: row.find('input[name="discount_amount[]"]').val() || '',
                                discount_percentage: row.find('input[name="discount_percent[]"]').val() || '',
                                agent_comission: row.find('input[name="agent_comission[]"]').val() || '',
                                toto: row.find('input[name="subtt[]"]').val() || '',
                                mrpp: row.find('input[name="mrp[]"]').val() || '',
                                lev: row.find('input[id^="lev_"]').val() || '',
                                rack: row.find('input[id^="rack_"]').val() || ''
                            };
                        ...
                        $.ajax({
                            url: "<?php echo site_url('purchase/addtodbb_update'); ?>",
                            type: "POST",
                            data: {
                                purchase_id: '<?= $id ?>',
                                pddate: pddate,
            ...
            <div class="panel-body" style="padding: 0px; padding-right: 1px;padding-left: 1px;">
                ...
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Purchase') ?> <?= label('Date') ?>
                        <input type="text" maxlength="30" value="<?php echo date('d-m-Y', strtotime($purchase->date)); ?>" name="pddate" class="form-control" id="pddate" placeholder="<?= label('Date') ?>">
                ...
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Purchase') ?> <?= label('Type') ?>
                        <select class="form-control" id="pptye" name="pptye">
                            <option value="0" <?= $purchase->ppurchase_type == '0' ? 'selected' : '' ?>>Cash </option>
                            <option value="1" <?= $purchase->ppurchase_type == '1' ? 'selected' : '' ?>>Credit</option>
                            <option value="2" <?= $purchase->ppurchase_type == '2' ? 'selected' : '' ?>>Cheque</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-2 pptye_1">
                    <div class="form-group"><?= label('Credit amount') ?>
                        <input type="text" name="credit_amount" id="credit_amount" value="<?= $purchase->credit_amount ?>" class="form-control" placeholder="Credit Amount">
                    </div>
                </div>
                <div class="col-sm-2 pptye_1">
                    <div class="form-group"><?= label(' No of Credit days') ?>
                        <input type="number" min="1" value="1" name="no_of_credit_days" value="<?= $purchase->no_of_credit_days ?>" id="no_of_credit_days" class="form-control" placeholder="No of Credit Days">
                    </div>
                </div>
                <div class="col-sm-2 pptye_2">
                    <div class="form-group"><?= label('Cheque') ?> <?= label('No') ?>
                        <input type="text" name="cheque_no" id="cheque_no" value="<?= $purchase->cheque_no ?>" class="form-control" placeholder="Cheque No">
                    </div>
                </div>
                <div class="col-sm-2 pptye_2">
                    <div class="form-group"><?= label('Cheque') ?> <?= label('Date') ?>
                        <input type="date" name="cheque_date" id="cheque_date" value="<?= $purchase->cheque_date ?>" class="form-control" placeholder="Cheque Date">
                    </div>
                </div>
                <script>
                    $(document).ready(function() {
                        ...
                        <div class="form-group"><?= label('Store') ?>
                            <select class="form-control" id="storrid" name="storrid">
                                ...
                                foreach ($mjms as $mjmfs) {
                                    $selected = $purchase->store_id == $mjmfs['id'] ? 'selected' : '';
                                ?>
                                    <option value="<?php echo $mjmfs['id']; ?>" <?= $selected ?>><?php echo $mjmfs['name']; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                ...
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Suppliers') ?><a href="javascript:void(0)" data-toggle="modal" data-target="#AddSupplier">
                            <span class="fa-stack fa-lg" data-toggle="tooltip" data-placement="top" style="height: 1em; line-height: 1em;" title="" data-original-title="Add New Suppliers">
                        ...
                        <select class="form-control" id="supp" name="supp">
                            ...
                            foreach ($mjm as $mjmf) {
                                $sup_select = $purchase->supplier_id == $mjmf['id'] ? 'selected' : '';
                            ?>
                                <option value="<?php echo $mjmf['id']; ?>" <?= $sup_select ?>><?php echo $mjmf['name']; ?></option>
                            <?php
                            }
                            ?>
                        </select>
            ...
            <div class="panel-body" style="padding: 0px;padding-right: 1px;padding-left: 1px;">
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Invoice') ?> <?= label('No') ?>
                        <input class="form-control topTab" type="text" name="innvno" value="<?= $purchase->invno ?>" id="innvno" value="" data-index="1">
                    </div>
                </div>

                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Invoice') ?> <?= label('Amount') ?>
                        <input class="form-control topTab" type="text" name="innvamt" value="<?= $purchase->invamt ?>" id="innvamt" value="0" data-index="2">
                    </div>
                </div>
                ...
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Invoice') ?> <?= label('Date') ?>
                        <input class="form-control" type="text" name="innvdda" id="innvdda" value="<?= $purchase->invdat ?>" value="<?php echo date('d-m-Y'); ?>" />
                    </div>
                </div>
                <div class="col-sm-2 ">
                    <div class="form-group"><?= label('Agent') ?>
                        <input class="form-control" type="text" name="agent" value="<?= $purchase->agent_name ?>" id="agent" value="" />
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="padding: 0px;">
                            ...
                            <table class="table table-bordered" style="margin-top: 10px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>CGST</td>
                                        <td>
                                            <input type="text" name="_cgst" id="_cgst" style="border: none;" value="0" readonly>
                                            <input readonly="readonly" type="text" class="form-control" id="cskgst" name="cskgst" style="display: none;" value="" placeholder="Total">
                                        </td>
                                        <td>Dis Amt</td>
                                        <td>
                                            <input type="text" class="form-control" id="total_invoice_discount_amount" name="total_invoice_discount_amount" value="<?= $purchase->total_invoice_discount_amount ?>" placeholder="">
                                            <input onkeyup="return callds(this.value,this.id);" type="text" class="form-control" style="display: none;" id="ddkst" name="ddkst" value="0" placeholder="">
                                        </td>
                                        <td></td>
                                        <td><input type="hidden" readonly class="form-control" id="agent_commission_amount" name="agent_commission_amount" value="<?= $purchase->agent_commission_amount ?>"></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>SGST</td>
                                        <td>
                                            <input type="text" name="_sgst" id="_sgst" style="border: none;" value="0" readonly>
                                        </td>
                                        <td>Dis %</td>
                                        <td>
                                            <input type="text" class="form-control" id="total_invoice_discount_percentage" name="total_invoice_discount_percentage" value="<?= $purchase->total_invoice_discount_percentage ?>" placeholder="">
                                        </td>
                                        <td>Agent %</td>
                                        <td>

                                            <input type="text" class="form-control" id="agent_commission" name="agent_commission" value="<?= $purchase->agent_commission ?>" placeholder="Agent Commission">
                                        </td>
                                        <td>Freight Cost</td>
                                        <td>
                                            <input type="text" class="form-control" id="freight_cost" name="freight_cost" value="<?= $purchase->freight_cost ?>" placeholder="Freight Cost">
                                        </td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>IGST</td>
                                        <td>
                                            <input type="text" name="_igst" id="_igst" style="border: none;" value="0" readonly>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        ...
                                        <td>Final Total</td>
                                        <td>
                                            <input readonly="readonly" type="text" class="form-control" id="afftot" name="afftot" value="" placeholder="Total">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Tax Total</td>
                            ...
                            <div class="row" style="margin-bottom: 50px;">
                                ...
                                <div class="col-md-2">
                                    <input type="Submit" class="form-control btn btn-green" id="aftot" name="Submit" value="Save" onclick="callcctt_fibnal();">
                                </div>
                            </div>
                            <!-- ========================================  -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('pos/load_posalesmsk/' . $id) ?>",
                data: {
                    producnum: 10
                },
                dataType: "html",
