...
?>
   ...
   <h3><?=label('Quotation');?> <?php if($kkar['ssa']==1){ ?><a style="float: right;" class="btn btn-primary btn-green" href="<?php echo base_url();?>quotation"  ><?=label('Add Quotation ');?> </a><?php } ?></h3>
   <hr>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('invoices/ajax_listqtt')?>",
            "type": "POST"
        },
    ...
    function delete_invoice(id)
    {
      ...
      function(){
         ...
         $.ajax({
            url : "<?php echo site_url('invoices/qajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
    ...
    function showInvoice(id){
      ...
      $.ajax({
          url : "<?php echo site_url('invoices/qshowInvoice')?>/"+id,
          type: "POST",
          success: function(data)
          {
    ...
    function showInvoice4(id){
      ...
      $.ajax({
          url : "<?php echo site_url('invoices/qshowInvoice4')?>/"+id,
          type: "POST",
          success: function(data)
          {
              $('#printSectionInvoice').html(data);
