...
<div class="container">
    <div class="row" style="margin-top:3px;">
        <h3><?= label('Dealer'); ?> <?= label('Purchase'); ?> <?= label('Reports'); ?> -<?= label('Dealer'); ?> </h3>
        <hr>
        <div class="row rangeStat" style="margin-top:1px;">
            ...
            <div class="col-sm-2 ">
                <div class="form-group"><?= label('Dealer'); ?>
                    ...
                    <select required="required" class="form-control" id="supp" name="supp">
                        ...
                        $suppliers = $db->query("select * from suppliers order by name asc")->getResult();
    ...
    <script>
            ...
            if (KeyID == 113 || KeyID == 115 || KeyID == 119) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        window.location.href = "<?php echo site_url() ?>report/purchasedealerreport";
                    },
        ...
        function getProducttaxReport() {
            ...
            $.ajax({
                url: "<?php echo site_url('reports/getpurchasedealerReport') ?>",
                type: "POST",
                data: {
                    Range: Range,
                    Range1: Range1,
