...
<div style="width:<?= esc($printSetup->dp_pt_width) ?>mm;font-size:<?= esc($printSetup->font_size_l) ?>px;margin-left:<?= esc($printSetup->margin_left) ?>px;padding:0px;">
    ...
    <!-- Continue adding structured ticket layout here: sale meta, customer, items, totals -->
    <!-- This is a placeholder, replicate rows as done in show_ticket4 using CI4-style HTML/PHP syntax -->
</div>