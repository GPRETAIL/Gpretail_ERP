    ...
    <div class="row" style="margin-top:10px;">
        <div class="col-md-12">
            ...
            $db = \Config\Database::connect();
              $uri = service('uri');
            $segg = $uri->getSegment(3);
            $perr = $db->table('purchases')
                    ->where('id', $segg)
                    ->get()
                    ->getRowArray();
            // $perr = $db->query("select * from purchases where id='" . $segg . "' ")->getRowArray();
                    ...
                    <div class="col-sm-2 ">
                        <div class="form-group"><?= label("Suppliers"); ?>
                            <select required="required" class="form-control" id="supp" name="supp">
                                ...
                                $mjm = $db->query("select * from suppliers order by name asc ");
                                foreach ($mjm->getResultArray() as $mjmf) {
                                ?>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-sm-12 ">
                        <div class="panel-body" style="padding: 0px;background-color: bisque;">
                            ...
                            if ($lxzmm['gst_tax'] == 1) {
                            ?>
                                <div style="text-align: center;text-align: left;" class="col-xs-1 table-header">
                                    <h7><?= label("tax"); ?></h7>
                                </div>
                            ...
                            ?>
                            <div style="width: 40px;text-align: left;padding: 0px 0px;" style="text-align: center;" class="col-xs-1 table-header">
                                <h7><?= label("Qty"); ?></h7>
                            </div>
                            ...
                            <div id="add1" class="col-xs-12">
                                ...
                                <div class="col-sm-3 " style="padding-right: 1px;padding-left: 1px;">
                                    <div class="form-group">
                                        <input style="padding: 0px 0px;" autocomplete="off" onkeyup="return auromcv(this.value,this.id);" class="form-control" type='text' id='countryname_1m' '/>
       <input      class="form-control" type='hidden' id="statediv_1m" />
                                ...
                                <div class="col-sm-1 " style="padding-right: 1px;padding-left: 1px;">
                                    <div class="form-group">
                                        <input readonly="readonly" style="padding: 0px 0px;" type="text" class="form-control" id="selling_1m" value="" placeholder="Cost"><br>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="hidden" id="totelemt" name="totelemt" value="<?php echo isset($kmx) ? $kmx : 0; ?>" />

                                <input type="hidden" id="countid" value="<?php echo isset($kmxv) ? $kmxv : 0; ?>">
                                ...
                                if ($lxzmm['gst_tax'] == 1) { ?>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="width:140px;" class="col-sm-1 "><br><?= label("CGST"); ?></div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div style="width:140px;" class="col-sm-1 "><br><?= label("SGST"); ?></div>

                                        <div class="col-sm-2 "><br>
                                            <input readonly="readonly" type="text" class="form-control" id="sskgst" name="sskgst" value="<?php echo $perr['sgst']; ?>" placeholder="">
                                        </div>
