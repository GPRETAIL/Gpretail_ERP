    ...
    <div class="col-md-12">
        ...
        <script type="text/javascript">
            ...
            function remove_education_fields(rid) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#afftot").val(amtt.toFixed(<?= $this->setting->decimals; ?>));
                        $("#innvamt").val(flss1.toFixed(<?= $this->setting->decimals; ?>));
            ...
            function callds(cc, bb) {
                ...
                $("#innvamt").val(kmxx.toFixed(<?= $this->setting->decimals; ?>));
