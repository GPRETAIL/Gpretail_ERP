...
<div class="container">
    ...
    <div class="row" style="margin-top:3px;">
        <h3><?= label('Supplier'); ?> <?= label('Payements'); ?> <?= label('Report'); ?> </h3>
        <hr>
        ...
        <div class="row rangeStat" style="margin-top:2px;">
            ...
            <div class="col-md-1">
                <div class="form-group">
                    ...
                    <input style="width:70px;" class="form-control" id="innon" type="text" name="innon" />
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <label><?= label('Pur'); ?>. <?= label('Number'); ?></label>


                    <input class="form-control" id="prrcc" type="text" name="prrcc" />
    ...
    <script>
        ...
        function getProducttaxReport() {
            ...
            $.ajax({
                url: "<?php echo site_url('reports/getProducttaxReportsupp') ?>",
                type: "POST",
                data: {
