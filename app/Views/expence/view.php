  <div class="container">
      ...
      <h3><?= label('Expense'); ?> <?php if ($kkar['exxa'] == 1) { ?>
              <button style="float: right;" class="btn btn-primary btn-green" type="button" class="btn btn-add btn-lg" data-toggle="modal" data-target="#AddExpence">
                  <?= label("Add Expence"); ?>
              </button><?php } ?>
      </h3>
      <hr>
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          table = $('#table').DataTable({
              ...
              "ajax": {
                  "url": "<?php echo site_url('ExpencesController/ajax_list') ?>",
                  "type": "POST"
              },
      ...
      function delete_expences(id) {
          swal({
              ...
              function() {
                  ...
                  $.ajax({
                      url: "<?php echo site_url('ExpencesController/ajax_delete') ?>/" + id,
                      type: "POST",
                      dataType: "JSON",
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <div class="form-group controls">
                      ...
                      <input value="<?php echo date("d-m-Y"); ?>" type="text" maxlength="30" Required name="date" class="form-control" id="Date" placeholder="<?= label("Date"); ?>">
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <textarea id="summernoted" class="form-control" name="note"></textarea>
                  </div>
              </div>
